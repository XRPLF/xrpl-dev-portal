...
1. **DeFi-primitive docs and "build a DEX/AMM/lending" guidance.** Deep, buildable docs on XRPL's DeFi capabilities — the native DEX and AMM, liquidity pools, lending/collateralization, order books/limit orders, slippage, and MEV considerations — so you can build a DEX and then a DeFi suite.
