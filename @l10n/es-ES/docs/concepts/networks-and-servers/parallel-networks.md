...
- **Tutoriales:**
    - [Conectar tu `xrpld` en laTestnet XRP](../../infrastructure/configuration/connect-your-xrpld-to-the-xrp-test-net.md)
    - [Usar xrpld en modo Stand-Alone](../../infrastructure/testing-and-auditing/index.md)
- **Referencias:**
    - [método server_info][]
