...
- **リポジトリ:**
    ...
    - {% source-link name="System Parameters" path="include/xrpl/protocol/SystemParameters.h#L43" /%}
    - {% source-link name="XRP Amount" path="include/xrpl/protocol/XRPAmount.h#L244" /%}
    - {% source-link name="Ledger Formats" path="include/xrpl/protocol/LedgerFormats.h#L36-L94" /%}
