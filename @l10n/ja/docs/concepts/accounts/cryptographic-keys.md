...
- Python 3: {% repo-link repo="devportal" path="_code-samples/key-derivation/py/key_derivation.py" %}このリポジトリのコードサンプルセクション{% /repo-link %}
...
1. 次のように、シード値から「ルートキーペア」を計算します。
    ...
    3. 結果が有効なsecp256k1秘密鍵でない場合は、ルートシーケンスを1増やして最初からやり直します。{% repo-link repo="xrpld" path="src/ripple/crypto/impl/GenerateDeterministicKey.cpp#L103" github_branch="fc7ecd672a3b9748bfea52ce65996e324553c05f" %}[ソース]{% /repo-link %}
