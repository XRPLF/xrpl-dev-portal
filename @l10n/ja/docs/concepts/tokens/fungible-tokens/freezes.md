...
フリーズについては、4種類の設定があります。

* [**Individual Freeze(個別のフリーズ)**](#individual-freeze) - 1件の取引相手をフリーズします。
* [**Deep Freeze(ディープフリーズ)**](#ディープフリーズ) - 個別のフリーズより強いフリーズ設定をします。
...
**ディープフリーズ**機能は、Individual Freezeより制限の厳しい形態のトラストラインに関する設定です。発行者がディープフリーズを実行すると、そのトラストライン上のトークンには以下のルールが適用されます。
...
カウンターパーティによる、ディープフリーズされたトラストライン上のトークンの売買[オファー](../decentralized-exchange/offers.md)は資金不足と見なされます。
- カウンターパーティは、ディープフリーズされたトラストライン上で、他のアドレスとの間で決済を行うことができません。
- [リップリング](./rippling)のステップの結果として、ディープフリーズされたトラストラインでの資金受け取りは失敗します。
...
- その個別アドレスが、ディープフリーズされたトラストライン上のトークンの売買オファーを作成することを防ぎます。
- リップリングのステップの結果として、ディープフリーズされたトラストラインでの資金受け取りは失敗します。

ディープフリーズはIndividual Freezeより上の段階の設定です。対象のトラストラインに対してIndividual Freezeが既に設定されているか、あるいは同時に設定される場合にのみ適用可能です。通常のIndividual Freezeは、ディープフリーズも同時に解除しない限り解除できませんが、ディープフリーズについては、Individual Freezeを維持したまま解除することが可能です。

アカウントで[No Freeze](#no-freeze)が有効になっている場合は、ディープフリーズを実行することはできません。
