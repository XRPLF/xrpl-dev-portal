...
{% responsive-graphic desktop="/docs/img/nft-brokered-mode-with-reserve.svg" mobile="/docs/img/nft-brokered-mode-with-reserve.mobile.svg" alt="リザーブありのブローカーモード：出品者がNFTを発行して最低価格で出品し、購入者が入札し、ブローカーが売却を成立させて手数料を受け取り、残りの入札をキャンセルします。" /%}
...
{% responsive-graphic desktop="/docs/img/nft-brokered-mode-without-reserve.svg" mobile="/docs/img/nft-brokered-mode-without-reserve.mobile.svg" alt="リザーブなしのブローカーモード：出品者がNFTを発行し、入札者がオファーを作成し、ブローカーが出品者に署名を依頼し、出品者が署名し、ブローカーが売却を完了して残りの入札をキャンセルします。" /%}
