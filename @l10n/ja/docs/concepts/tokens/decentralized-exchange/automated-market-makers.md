...
![自動マーケットメーカー](/docs/img/cpt-amm.svg)

資産をAMMに預ける人は、_流動性供給者(LP/Liquidity Provider)_ と呼ばれます。その対価として流動性供給者はAMMからLPトークンを受け取ります。

<div align="center">

![流動性提供者によるLPトークンの受け取り](/docs/img/cpt-amm-lp-receiving-lpts.svg)
...
![オファーやAMMまたはその両方を利用する1つの取引](/docs/img/cpt-amm-or-offer.svg)
...
![資産残高が増えると価格が下がり、資産残高が減ると価格が上がる](/docs/img/cpt-amm-balance.svg)
...
![DEXのオファーの経路](/docs/img/amm-clob-diagram.svg)
