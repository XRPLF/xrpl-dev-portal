...
| `tfSetDeepFreeze` | `0x00400000` | 4194304       | トラストラインを[ディープフリーズ](../../../../concepts/tokens/fungible-tokens/freezes.md#ディープフリーズ) します。 |
| `tfClearDeepFreeze` | `0x00800000` | 8388608     | トラストラインの[ディープフリーズ](../../../../concepts/tokens/fungible-tokens/freezes.md#ディープフリーズ) を解除します。 |
