...
_`validators`リクエストは、権限のないユーザは実行できない[管理メソッド](../index.md)です。_
...
```json
{
  ...
  "result": {
    ...
    "publisher_lists": [
      {
        ...
        "list": ["nHBtBkHGfL4NpB54H1AwBaaSJkSJLUSPvnUNAcuNpuffYB51VjH6", "nHBe4vqSAzjpPRLKwSFzRFtmvzXaf5wPPmuVrQCAoJoS1zskgDA4"],
    ...
    "signing_keys": {},
    "status": "success",
    "trusted_validator_keys": ["nHBe4vqSAzjpPRLKwSFzRFtmvzXaf5wPPmuVrQCAoJoS1zskgDA4", "nHBtBkHGfL4NpB54H1AwBaaSJkSJLUSPvnUNAcuNpuffYB51VjH6"],
    "validation_quorum": 2,
