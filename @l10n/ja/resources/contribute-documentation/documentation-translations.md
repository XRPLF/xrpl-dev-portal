...
XRP Ledger Dev Portalをあなたの母国語に翻訳したい場合は、まず{% repo-link repo="devportal" path="docs/introduction/what-is-the-xrp-ledger.md" %}"What is the XRP Ledger?" file{% /repo-link %}から始めてください。
