...
export const frontmatter = {
  seo: {
    ...
    description:
      "Here's how the XRP Ledger is used to power innovative technology across the payments and public blockchain landscape.",
  },
};
...
export default function Uses() {
  ...
  const UpdateModalContent = ({ id, title, description, logos }) => {
    ...
    const createLogoElement = (logoClassName, title, id) => {
      return (
        <div key={logoClassName} className={`logo-item ${logoClassName}`}></div>
      );
    };
            ...
            <div className="col-12 col-lg-8 col-xl-6 p-3 mb-5">
              <div className="d-flex flex-column-reverse">
                <h3 className="h4 h2-sm">
                  {translate(
                    'about.uses.businesses.h3part1',
                    'Businesses and developers',
                  )}
                  <br className="until-sm" />
                  {translate(
                    'about.uses.businesses.h3part2',
                    'rely on the XRP Ledger',
                  )}
                </h3>
                <h6 className="eyebrow mb-3">
