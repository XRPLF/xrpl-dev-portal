...
const logos = {
  infrastructure: ['xrp-ledger', 'gatehub', 'towolabs', 'xrpscan', 'xrp-toolkit', 'bithomp', 'onthedex'],
  ...
  nfts: ['aesthetes', 'audiotarky', 'nftmaster', 'peerkat', 'sologenic_dex', 'xrp-cafe', 'xrp-oval'],
...
const cardsData = [
  ...
  },
  {
    id: 'anchain-ai',
    title: 'Anchain.AI',
    description: 'AnChain.AI offers AI-powered intelligence enhancing blockchain security, risk, and compliance strategies.',
  ...
  },
  {
    id: 'audiotarky',
    title: 'Audiotarky',
    description: 'Audiotarky is a new music streaming platform that prioritises artists and privacy over algorithms and shareholders.',
    category_id: 'nfts',
    category_name: 'NFTs',
  ...
  },
  {
    id: 'futureverse',
    title: 'Futureverse',
    description: 'Revolutionary AI + metaverse technologies that enable open, scalable, and interoperable apps, games, and experiences.',
    category_id: 'gaming',
    category_name: 'Gaming',
  ...
  },
  {
    id: 'gatehub',
    title: 'Gatehub',
    description: "Gatehub XRP Ledger Markets is an explorer to track Gatehub's inssuances on the XRP Ledger.",
    category_id: 'custody',
    category_name: 'Custody',
  ...
  },
  {
    id: 'bitpay',
    title: 'bitpay',
    description: 'BitPay builds powerful, enterprise-grade tools for accepting and spending cryptocurrencies, including XRP.',
  ...
  },
  {
    id: 'cryptum',
    title: 'Cryptum',
    description: 'Cryptum is an API/SDK platform for integrating the XRP Ledger with any application.',
  ...
  },
  {
    id: 'evernode',
    title: 'Evernode',
    description: 'Evernode proposes a permissionless, flexible, scalable Layer 2 smart contract network built from the XRP Ledger.',
    category_id: 'developer_tooling',
    category_name: 'Developer Tooling',
  ...
  },
  {
    id: 'ledger-city',
    title: 'Ledger City',
    description: 'Ledger City is a crypto real estate game powered by the XRP Ledger.',
    category_id: 'gaming',
    category_name: 'Gaming',
  ...
  },
  {
    id: 'nft-master',
    title: 'NFT Master',
    description: 'NFT Master is an NFT marketplace where creators can buy, mint and sell NFTs.',
    category_id: 'nfts',
    category_name: 'NFTs',
  ...
  },
  {
    id: 'onthedex',
    title: 'OnTheDex',
    description: 'OnTheDex is a quality source of information for aggregator sites to take live feeds of XRPL token activity.',
    category_id: 'infrastructure',
    category_name: 'Infrastructure',
  ...
  },
  {
    id: 'onxrp',
    title: 'onXRP',
    description: 'onXRP is an NFT marketplace where creators can buy, mint and sell NFTs built by the XPUNKs.',
    category_id: 'nfts',
    category_name: 'NFTs',
  ...
  },
  {
    id: 'peerkat',
    title: 'Peerkat',
    description: 'Peerkat is an NFT services and tooling provider for the XRPL community.',
    category_id: 'nfts',
    category_name: 'NFTs',
  ...
  },
  {
    id: 'Crossmark',
    title: 'Crossmark',
    description: 'Crossmark is a browser extension wallet built for interacting with the XRP Ledger.',
    category_id: 'wallet',
    category_name: 'Wallet',
  ...
  },
  {
    ...
    description: 'Ripple powers real-time, low-cost cross-border payment settlement  by using XRP as a bridge currency between two fiat currencies.',
    category_id: 'payments',
    category_name: 'Payments',
  ...
  },
  {
    id: 'sologenic-dex',
    title: 'Sologenic DEX',
    description: 'Sologenic DEX is a popular decentralized exchange on the XRP Ledger made by Sologenic.',
  ...
  },
  {
    ...
    description: 'First Ledger is the fastest way to trade on the xrpl. This tool allows you to trade with speed within a couple of clicks.',
    category_id: 'exchanges',
    category_name: 'Exchanges',
  ...
  },
  {
    id: 'xp-market',
    title: 'XP Market',
    description: 'XP Market is a price-tracking website for cryptoassets on the XRPL coupled with a decentralized exchange.',
    category_id: 'exchanges',
    category_name: 'Exchanges',
  ...
  },
  {
    id: 'xrp-cafe',
    title: 'XRP Cafe',
    description: 'XRP Cafe is an NFT marketplace built by the community that aims to be the easiest way to build, sell and mint NFTs.',
    category_id: 'nfts',
    category_name: 'NFTs',
    link: 'https://xrp.cafe/',
  },
  {
    id: 'xrp-toolkit',
    title: 'XRP Toolkit',
    description: "XRP Toolkit is a platform for managing crypto assets and trading on the XRP Ledger's decentralized exchange.",
    category_id: 'infrastructure',
    category_name: 'Infrastructure',
  ...
  },
  {
    id: 'xrpl-rosetta',
    title: 'XRPL Rosetta',
    description: 'XRPL Rosetta explores fiat data on XRPL through visualization.',
    category_id: 'infrastructure',
    category_name: 'Infrastructure',
  ...
  },
  {
    ...
    description: "XRPL.org's Ledger Explorer is a block explorer of the XRP Ledger.",
    category_id: 'infrastructure',
    category_name: 'Infrastructure',
  ...
  },
  {
    id: 'xumm-wallet',
    title: 'Xaman',
    description: 'Xaman is a non custodial wallet with superpower for the XRP Ledger.',
    category_id: 'wallet',
    category_name: 'Wallet',
...
const uses = [
  ...
  },
  {
    ...
    number: 1,
    description: "Developers and node operators can build and run custom sidechains while leveraging the XRPL's lean and efficient feature set.",
  },
  {
    id: 'wallet',
    title: 'Wallet',
...
export default function Uses() {
  ...
  const filteredCards = cards.filter((card) => selectedCategories.has(card.category_id))
  ...
  const UpdateModalContent = ({ id, title, description, logos }) => {
    ...
    const createLogoElement = (logoClassName, title, id) => {
      return <div key={logoClassName} className={`logo-item ${logoClassName}`}></div>
    }
    ...
    const renderLogoRows = () => {
      ...
      return (
        <>
          <div className="top-row">{topRow.map((logoClassName) => createLogoElement(logoClassName, title, id))}</div>
          {bottomRow.length > 0 && (
            <div className="bottom-row" style={bottomRowStyle}>
              {bottomRow.map((logoClassName) => createLogoElement(logoClassName, title, id))}
            </div>
          )}
        </>
      )
    ...
    return (
      <>
        ...
        <div className="content-section">
          <img className="section-image" alt="section image" width={40} height={40} id={id} />
        </div>
        <div className="content-section">
    ...
    <div className="landing page-uses landing-builtin-bg">
      <div>
        <div className="overflow-hidden">
          <section className="container-new py-26 text-lg-center">
            <div className="p-3 col-lg-8 mx-lg-auto">
              <div className="d-flex flex-column-reverse">
                <h1 className="mb-0">{translate('Powering Innovative Use Cases and Projects')}</h1>
            ...
            <div className="col-lg-5 p-3">
              <div className="d-flex flex-column-reverse">
                <div className="d-flex justify-content-start align-items-center">
                  ...
                  <span className="explore-projects">{translate('Explore Featured Projects')}</span>
                </div>
                <p className="text-sm">
                  {translate(
                ...
                <h6 className="eyebrow mb-3">{translate('Introducing the XRPL Ecosystem')}</h6>
              </div>
            </div>
            <div className="col-lg-5 offset-lg-2 p-5 d-flex">
              <div className="mb-4 pb-3 numbers-animation">{View}</div>
              <div className="apps-built">
                {translate('about.uses.apps-build-1', 'Apps/exchanges ')}
                <br />
                {translate('about.uses.apps-build-2', 'built on the ')}
                <br />
                {translate('about.uses.apps-build-3', 'XRPL')}
              </div>
            </div>
            <ul className="card-grid use-cases-grid ls-none mt-4 pt-lg-2" id="use-case-card-grid">
              {uses.map((use, index) => (
                <li
                  key={use.id}
          ...
          <div className={`modal modal-uses ${modalData?.id} ${displayModal ? 'd-block' : ''}`} id="myModal">
            <div
              ref={modalRef} // Attach the reference to the modal
              className="modal-content-uses"
            >
              <UpdateModalContent id={modalData?.id} title={modalData?.title} description={modalData?.description} logos={logos} />
            </div>
          </div>
          <section className="join-xrpl-section py-26">
            <div className="colorful-join-text-wrapper">
              ...
              <div className="mt-10">
                <a target="_blank" className="btn btn-primary btn-arrow" href="https://xrplresources.org/developer-spotlight">
          ...
          <section className="container-new py-26">
            <div className="col-12 col-lg-8 col-xl-6 p-3 mb-5">
              <div className="d-flex flex-column-reverse">
                ...
                <h6 className="eyebrow mb-3">{translate('Solving Real-World Problems')}</h6>
              </div>
            ...
            <a className="btn d-block d-lg-none" data-toggle="modal" data-target="#categoryFilterModal">
              <span className="mr-3">
                <img src={require('../static/img/uses/usecase-filter.svg')} alt="Filter button" />
              </span>
            ...
            <div className="row col-12 m-0 p-0 mt-4 pt-2">
                ...
                <div className="p-3 category_sidebar">
                  <form>
                    <p className="category-header mb-4">
                      ...
                      <span id="featured_count_old" className="featured_count category_count">
                        {featuredCount}
                      </span>
                    </p>
                    {Object.keys(featured_categories).map((item) => (
                      <div key={item} className="cat_checkbox category-checkbox pb-2">
                        <input
                          ...
                          defaultChecked
                        />
                        <label className="font-weight-bold" htmlFor={`input_${item}`}>
                    ...
                    <p className="category-header pt-5 mt-3 mb-4">
                      ...
                      <span id="other_count_old" className="other_count category_count">
                        {otherCount}
                      </span>
                    </p>
                    {Object.keys(other_categories).map((item) => (
                      <div key={item} className="cat_checkbox category-checkbox pb-2">
                        <input
                          ...
                          onChange={() => toggleCategory(item)}
                        />
                        <label htmlFor={`input_${item}`}>{translate(other_categories[item])}</label>
                      </div>
                    ))}
                  </form>
                </div>
              ...
              {/* cards */}
              <div className="right row col row-cols-lg-2 m-2 p-0" id="use_case_companies_list">
                {filteredCards.map((card) => (
                  <a key={card.id} className={`card-uses category_${card.category_id}`} href={card.link} target="_blank" id={card.id}>
                    <div className="card-body row">
                      <span className="w-100 mb-3 pb-3">
                        <img className="mw-100 biz-logo" alt={`${card.title}|default${card.id}`} />
                      </span>
                      <h4 className="card-title h6">{card.title}</h4>
                      <p className="card-text">{translate(card.description)}</p>
                      <div className="align-self-end">
                        <span className={`label label-use-${card.category_id}`}>{translate(card.category_name)}</span>
                      </div>
                    </div>
                  </a>
                ))}
