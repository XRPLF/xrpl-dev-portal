...
export const frontmatter = {
  seo: {
    title: 'LogoRectangleGrid Component Showcase',
    description: "A comprehensive showcase of the LogoRectangleGrid pattern component with rectangle tiles, responsive grid layouts, dynamic alignment, color variants, and usage examples.",
  }
};

export default function LogoRectangleGridShowcase() {
      ...
      <div className="overflow-hidden">
        ...
        <section className="my-5 text-center">
          <div className="col-lg-8 mx-auto">
            ...
            <h1 className="mb-4">LogoRectangleGrid Pattern</h1>
            <p className="longform">
              A responsive grid pattern for displaying company/partner logos with rectangle tiles (9:5 aspect ratio) 
              and dynamic alignment based on tile count. Features 2 color variants with full dark mode support.
              The grid automatically adapts from 2 columns on mobile to 3 columns on tablet to 4 columns on desktop,
              with intelligent alignment that changes based on the number of logos displayed.
            </p>
          </div>
        </section>
        ...
        <PageGrid className="my-5">
          <PageGridRow>
            <PageGridCol span={12}>
              ...
              <p className="mb-6">
                LogoRectangleGrid automatically adapts its grid layout based on viewport width.
                ...
                <div className="d-flex flex-row gap-4 align-items-start" style={{ flexWrap: 'wrap' }}>
                  <div style={{ flex: '1 1 300px', minWidth: '280px' }}>
                    ...
                    <ul className="mb-0">
                      ...
                      <li><strong>Tile Aspect Ratio:</strong> 9:5</li>
        ...
        <PageGrid className="my-5">
          <PageGridRow>
            <PageGridCol span={12}>
              <h2 className="h4 mb-6">Dynamic Alignment Logic</h2>
              <p className="mb-6">
                The grid alignment changes based on the number of logos to create a visually balanced layout:
              </p>
              <ul className="mb-6">
                <li><strong>1-3 logos:</strong> Right-aligned (offset from left)</li>
                <li><strong>4 logos:</strong> Left-aligned (no offset)</li>
                <li><strong>5-9 logos:</strong> Right-aligned (offset from left)</li>
                <li><strong>9+ logos:</strong> Left-aligned (no offset)</li>
              </ul>
            </PageGridCol>
          </PageGridRow>
        </PageGrid>

        {/* 2 Logos - Right Aligned */}
        <div className="mb-5">
          <PageGrid>
            <PageGridRow>
              <PageGridCol span={12}>
                <div className="mb-3">
                  <strong>2 Logos</strong> - Right-aligned
                </div>
              </PageGridCol>
            </PageGridRow>
          </PageGrid>
          <LogoRectangleGrid
            ...
            logos={logosArrray.slice(0, 2)}
          />
        </div>

        {/* 3 Logos - Right Aligned */}
        <div className="mb-5">
          <PageGrid>
            <PageGridRow>
              <PageGridCol span={12}>
                <div className="mb-3">
                  <strong>3 Logos</strong> - Right-aligned
                </div>
              </PageGridCol>
            </PageGridRow>
          </PageGrid>
          <LogoRectangleGrid
            ...
            description="Essential tools for building on XRPL."
            logos={logosArrray.slice(0, 3)}
          />
        </div>
        ...
        <div className="mb-5">
          <PageGrid>
            <PageGridRow>
              <PageGridCol span={12}>
                <div className="mb-3">
                  <strong>4 Logos</strong> - Left-aligned
                </div>
              </PageGridCol>
            </PageGridRow>
          </PageGrid>
          <LogoRectangleGrid
            ...
            logos={logosArrray.slice(0, 4)}
          />
        </div>

        {/* 6 Logos - Right Aligned */}
        <div className="mb-5">
          <PageGrid>
            <PageGridRow>
              <PageGridCol span={12}>
                <div className="mb-3">
                  <strong>6 Logos</strong> - Right-aligned
                </div>
              </PageGridCol>
            </PageGridRow>
          </PageGrid>
          <LogoRectangleGrid
            ...
            description="Comprehensive tools and libraries for XRPL development."
            logos={logosArrray.slice(0, 6)}
          />
        </div>

        {/* 8 Logos - Right Aligned */}
        <div className="mb-5">
          <PageGrid>
            <PageGridRow>
              <PageGridCol span={12}>
                <div className="mb-3">
                  <strong>8 Logos</strong> - Right-aligned
                </div>
              </PageGridCol>
            </PageGridRow>
          </PageGrid>
        ...
        {/* 12 Logos - Left Aligned */}
        <div className="mb-5">
          <PageGrid>
            <PageGridRow>
              <PageGridCol span={12}>
                <div className="mb-3">
                  <strong>12 Logos</strong> - Left-aligned (9+ logos)
                </div>
              </PageGridCol>
            </PageGridRow>
          </PageGrid>
          <LogoRectangleGrid
            ...
            description="Companies and organizations building on the XRP Ledger ecosystem."
            logos={logosArrray}
          />
        </div>
        ...
        <PageGrid className="my-5">
          <PageGridRow>
            <PageGridCol span={12}>
              ...
              <p className="mb-6">
                LogoRectangleGrid comes in 2 color variants to support different visual contexts.
        ...
        <PageGrid className="my-5">
          <PageGridRow>
            <PageGridCol span={12}>
              ...
              <p className="mb-6">
                The component requires a heading but supports flexible configurations including optional descriptions and clickable logos.
              </p>
            </PageGridCol>
          </PageGridRow>
        </PageGrid>
            ...
            <PageGridRow>
              <PageGridCol span={12}>
                <div className="mb-3">
                  ...
                  <br />
                  <small className="text-muted">Each logo can link to an external URL. Hover to see the window shade animation.</small>
                </div>
              </PageGridCol>
            </PageGridRow>
          </PageGrid>
            ...
            <PageGridRow>
              <PageGridCol span={12}>
                <div className="mb-3">
                  ...
                  <br />
                  <small className="text-muted">Component with just a heading, no description.</small>
                </div>
              </PageGridCol>
            </PageGridRow>
          </PageGrid>
            ...
            <PageGridCol span={12}>
              ...
              <div className="mb-10">
                ...
                <div className="d-flex flex-row py-3" style={{ gap: '1rem', borderBottom: '1px solid var(--bs-border-color, #dee2e6)' }}>
                  ...
                  <div style={{ flex: '1 1 0', minWidth: 0 }}>Heading text (required)</div>
                </div>
                ...
                <div className="d-flex flex-row py-3" style={{ gap: '1rem', borderBottom: '1px solid var(--bs-border-color, #dee2e6)' }}>
                  ...
                  <div style={{ width: '120px', flexShrink: 0 }}><em>required</em></div>
                  <div style={{ flex: '1 1 0', minWidth: 0 }}>Array of logo items (src, alt, href?, onClick?, disabled?)</div>
                </div>
          ...
          <PageGridRow>
            <PageGridCol span={12}>
              ...
              <ul className="mb-6">
                ...
                <li>Keep logos reasonably sized (width: 150-250px recommended for rectangle tiles)</li>
                ...
                <li>Rectangle tiles work well with horizontal logos</li>
              </ul>

              <h4 className="h5 mb-4">Content Guidelines</h4>
              <ul className="mb-6">
                <li><strong>Heading:</strong> Required, keep concise (1-2 lines preferred), use sentence case</li>
                <li><strong>Description:</strong> Optional, provide context (2-3 lines max), complete sentences</li>
                <li><strong>Logo Count:</strong> Consider the alignment logic when choosing how many logos to display</li>
              ...
              <h4 className="h5 mb-4">Understanding Alignment Logic</h4>
              <ul className="mb-6">
                <li><strong>1-3 logos:</strong> Right-alignment creates a compact, focused presentation</li>
                <li><strong>4 logos:</strong> Left-alignment fills the full width for balanced display</li>
                <li><strong>5-9 logos:</strong> Right-alignment maintains visual coherence</li>
                <li><strong>9+ logos:</strong> Left-alignment accommodates larger grids efficiently</li>
              </ul>
            </PageGridCol>
          </PageGridRow>
        </PageGrid>
            ...
            <PageGridCol span={12}>
              ...
              <div className="d-flex flex-column gap-3">
                <div>
                  ...
                  <a href="https://www.figma.com/design/gaTsImoTRsiRXAGzbGKcCd/Section-Logo---Rectangle-Grid?node-id=1-2" target="_blank" rel="noopener noreferrer">
                    Section Logo - Rectangle Grid (Figma)
                  </a>
                </div>
                <div>
