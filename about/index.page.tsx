  ...
  return (
    <div className="landing">
      <div className="overflow-hidden">
        <div id="video-overlay" className={`${!!currentVideoUrl?.length && 'd-block'}`} />
        <div id="video" className={`${!!currentVideoUrl?.length && 'd-block'}`}>
          <div id="videoWrapper" ref={modalRef}>
            <iframe id="player" width={853} height={480} src={currentVideoUrl} frameBorder={0} allowFullScreen />
          </div>
        </div>
        ...
        <section className="py-26 text-center">
          <div className="col-lg-5 mx-auto text-center">
            <div className="d-flex flex-column-reverse">
              ...
              <h6 className="eyebrow mb-3">{translate('XRPL Today, XRPL Tomorrow')}</h6>
            </div>
          </div>
        </section>
        ...
        <section className="container-new py-26">
          <div className="card-grid card-grid-2xN">
            <div className="col">
              <div className="d-flex flex-column-reverse">
                <h2 className="h4 h2-sm mb-8">{translate('How the XRP Ledger works')}</h2>
                <h6 className="eyebrow mb-3">{translate('XRP Ledger Basics')}</h6>
              </div>
              <h5 className="longform mb-10">{translate('The XRP Ledger is a decentralized public blockchain built for business.')}</h5>
              <p className="mb-4">
                {translate(
        ...
        <section className="container-new py-26">
          <div className="card-grid card-grid-2xN">
            <div className="col">
              <div className="d-flex flex-column-reverse">
                <h2 className="h4 h2-sm mb-8">{translate('How the Consensus Protocol works')}</h2>
                <h6 className="eyebrow mb-3">{translate('Consensus')}</h6>
              </div>
              <h5 className="longform mb-10">
                {`${translate('about.index.consensus.h5part1', 'To uphold performance, XRPL uses a consensus protocol. Designated servers called ')}`}
                <Link to="/docs/infrastructure/configuration/server-modes/run-rippled-as-a-validator">
                  {translate('about.index.consensus.h5part2', 'validators')}
                </Link>
                {`${translate(
              ...
              <p className="mb-0">
                ...
                <a href="https://livenet.xrpl.org/network/validators" target="_blank">
                  {translate('about.index.consensus.ppart2', 'validators')}
                </a>
                {translate(
                  'about.index.consensus.ppart3',
                  ' are active on the ledger, operated by universities, exchanges, businesses, and individuals. As the validator pool grows, the consensus protocol ensures decentralization of the blockchain over time.',
                )}
              </p>
            </div>
        ...
        <section className="container-new py-26">
          <div className="col-md-6 offset-md-3 p-6-sm p-10-until-sm br-8 cta-card">
            <img alt="green waves" src={require('../static/img/backgrounds/cta-xrpl-overview-green.svg')} className="cta cta-bottom-right" />
            <div className="z-index-1 position-relative">
              <h2 className="h4 mb-10-until-sm mb-8-sm">{translate('A Sustainable Blockchain')}</h2>
              <p className="mb-10">
                {translate(
        ...
        <section className="container-new py-26">
          <div className="card-grid card-grid-2xN">
            <div className="col">
              ...
              <h5 className="longform mb-10">
                {translate('With 10+ years of error-free functioning and enterprise companies as champions, XRPL has established reliability.')}
              </h5>
              <p className="mb-10">
                {translate(
            ...
            <div className="col mb-0">
              <div className="d-flex flex-column-reverse">
                <h4 className="h4 h2-sm mb-8">{translate('Creating new value for long-term growth')}</h4>
        ...
        <section className="container-new py-26">
          <div className="d-flex flex-column-reverse col-xl-6 mb-lg-4 pl-0 ">
            <h2 className="h4 h2-sm">{translate('Watch the explainer video series to learn more about the XRP Ledger')}</h2>
          ...
          <div className="row row-cols-1 row-cols-lg-3 d-flex justify-content-between w-100 mx-0 mx-md-n3 mt-md-5">
            <div className="px-md-3 pt-5 pt-md-0">
              <a onClick={() => setCurrentVideoUrl('https://www.youtube.com/embed/k6VqEkqRTmk?rel=0&showinfo=0&autoplay=1')} className="btn1">
                <img
              ...
              <div className="mt-2">
                <h4 className="video-title mt-3 mb-0">{translate('The Consensus Mechanism')}</h4>
              </div>
            </div>
            <div className="px-md-3 pt-5 pt-md-0">
              <a onClick={() => setCurrentVideoUrl('https://www.youtube.com/embed/JjaVDXPqnbA?rel=0&showinfo=0&autoplay=1')} className="btn1">
                <img
              ...
              <div className="mt-2">
                <h4 className="video-title mt-3 mb-0">{translate('Nodes and Validators')}</h4>
              </div>
            </div>
            <div className="px-md-3 pt-5 pt-md-0">
              <a onClick={() => setCurrentVideoUrl('https://www.youtube.com/embed/WsmldDNGQ9s?rel=0&showinfo=0&autoplay=1')} className="btn1">
                <img
              ...
              <div className="mt-2">
                <h4 className="video-title mt-3 mb-0">{translate('Sustainability of the XRP Ledger')}</h4>
              </div>
            </div>
          </div>
          <div className="pt-5 w-100">
            <a className="btn btn-primary btn-arrow" target="_blank" href="https://www.youtube.com/channel/UC6zTJdNCBI-TKMt5ubNc_Gg">
        ...
        <section className="container-new py-26">
          <div className="col-md-6 offset-md-3 p-6-sm p-10-until-sm br-8 cta-card">
            <img alt="orange waves" src={require('../static/img/backgrounds/cta-xrpl-overview-orange.svg')} className="cta cta-bottom-right" />
            <div className="z-index-1 position-relative">
              <h4 className="h4 mb-10-until-sm mb-8-sm">{translate('Tomorrow’s Blockchain Starts With You')}</h4>
              <p className="mb-10">
                {`${translate(
                ...
                <Link to="/community/developer-funding">{translate('about.index.tomorrow.ppart2', ' blockchain project')}</Link>
          ...
          <div className="col-md-6 offset-md-3 w-100 pl-0 pr-0 mini-faq" id="minifaq-accordion">
            {faqs.map((faq, index) => (
              <div className="q-wrapper" key={index}>
                ...
                <div id={`answer${index + 1}`} className="answer-wrapper collapse" aria-labelledby={`heading${index + 1}`}>
