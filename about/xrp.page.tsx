...
export default function XrpOverview() {
  ...
  React.useEffect(() => {
    const handleScroll = () => {
      const sections = ['about-xrp', 'xrp-trading', 'ripple', 'wallets', 'exchanges']
    ...
    <div className="landing">
      <div>
        <div className="position-relative">
          <img alt="blue waves" src={require('../static/img/backgrounds/xrp-overview-blue.svg')} className="landing-bg" id="xrp-overview-blue" />
        </div>
        <section className="py-26 text-center">
          <div className="col-lg-5 mx-auto text-center">
            <div className="d-flex flex-column-reverse">
              <h1 className="mb-0">{translate('Your Questions About XRP, Answered')}</h1>
          ...
          <div className="card-grid card-grid-1x2">
            <div className="d-none-sm mt-lg-0">
              <ul className="page-toc no-sideline p-0 sticky-top floating-nav">
                {links.map((link) => (
                  <li key={link.hash} className={`nav-item ${activeSection === link.hash.substring(1) ? 'active' : ''}`}>
                    <a className={`sidelinks nav-link ${activeSection === link.hash.substring(1) ? 'active' : ''}`} href={link.hash}>
                      {translate(link.text)}
                    </a>
                  </li>
                ))}
            ...
            <div className="col mt-lg-0">
              <div className="link-section pb-26" id="about-xrp">
                ...
                <h5 className="longform mb-10">
                  ...
                  <a href="https://www.distributedagreement.com/2018/09/24/what-is-a-blockchain/" target="_blank" rel="noopener noreferrer">
                  ...
                  <table className="mb-10 landing-table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{translate('Environmentally sustainable (negligible energy consumption)')}</td>
                        <td>{translate('0.3% of global energy consumption')}</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                ...
                <div className="card-grid card-grid-2xN mb-10">
                  <div>
                    <img alt="briefcase" className="mw-100 mb-2 invertible-img" src={briefcaseIcon} />
                    <h6 className="fs-4-5">{translate('Financial Institutions')}</h6>
                    <p className="">
                      {translate('Leverage XRP as a bridge currency to facilitate faster, more affordable cross-border payments around the world.')}
                    </p>
                  </div>
                  <div>
                    <img alt="user" className="mw-100 mb-2 invertible-img" src={userIcon} />
                    <h6 className="fs-4-5">{translate('Individual Consumers')}</h6>
                    <p>{translate('Use XRP to move different currencies around the world.')}</p>
                  </div>
                </div>
                <div className="mt-10 p-10 br-8 cta-card position-relative">
                  <img alt="magenta waves" src={require('../static/img/backgrounds/cta-xrp-overview-magenta.svg')} className="cta cta-bottom-right" />
                  <div className="z-index-1 position-relative">
                    <h2 className="h4 mb-10-until-sm mb-8-sm">{translate('The XRP Ledger is built for business.')}</h2>
                    <p className="mb-10">
                      {translate(
              ...
              <div className="py-26 link-section" id="xrp-trading">
                <h2 className="h4 h2-sm mb-8">{translate('How Is XRP Used in Trading?')}</h2>
                <h5 className="longform mb-10">{translate('XRP is traded on more than 100 markets and exchanges worldwide.')}</h5>
                <p className="mb-6">
                  {translate(
                  ...
                  <a href="https://ripple.com/insights/xrp-a-preferred-base-currency-for-arbitrage-trading/" target="_blank">
                    {translate('about.xrp.xrp-in-trading.ppart2', 'seizing arbitrage opportunities')}
                  </a>
                  {translate('about.xrp.xrp-in-trading.ppart3', ', servicing margin calls and managing general trading inventory in real time.')}
                </p>
              ...
              <div className="py-26 link-section" id="ripple">
                <h2 className="h4 h2-sm mb-8">{translate('What Is the Relationship Between Ripple and XRP?')}</h2>
                <h5 className="longform mb-10">
                    ...
                    <h3 className="h4">
                      ...
                      <span className="d-inline-flex">
                        <img
                          ...
                          alt="XRP Logo Mark"
                        />
                        <span className="numbers stat-highlight" id="ripple-escrow-amount">
                          {translate('38B')}
                        </span>
                      </span>
                      <br />
              ...
              <div className="link-section py-26" id="wallets">
                <h2 className="h4 h2-sm mb-8">{translate('What Wallets Support XRP?')}</h2>
                <h5 className="longform mb-10">
                  {translate(
                ...
                <ul className={`nav nav-grid-lg cols-of-${totalCols}`} id="wallets">
                  ...
                  {softwallets.map((wallet) => (
                    <li key={wallet.id} className="nav-item">
                      <a className="nav-link external-link" href={wallet.href} target="_blank">
                        <img className={`mw-100 ${!!wallet?.imgclasses && wallet.imgclasses}`} id={wallet.id} alt={wallet.alt} />
                      </a>
                    </li>
                  ))}
                  <li className="nav-item nav-grid-head">
              ...
              <div className="py-26 link-section" id="exchanges">
                <h2 className="h4 h2-sm mb-8">{translate('What Exchanges Support XRP?')}</h2>
                <h5 className="longform mb-10">
                ...
                <div className="card-grid card-grid-2xN mb-10">
                  ...
                  <div>
                    <h6 className="fs-4-5">{translate('Futures, Options and Swap Exchanges')}</h6>
                    <p className="mb-0">
                      {translate(
                ...
                <h6>{translate('Top Exchanges, according to CryptoCompare')}</h6>
                <ul className="nav nav-grid-lg cols-of-5 mb-10" id="top-exchanges">
                  {exchanges.map((exch, i) => (
                    <li className="nav-item" key={exch.id}>
                      <a className="nav-link external-link" href={exch.href} target="_blank">
