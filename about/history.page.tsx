    ...
    <div className="landing">
      <div className="overflow-hidden">
        ...
        <section className="py-26 text-center">
          <div className="col-lg-5 mx-auto text-center">
            <div className="d-flex flex-column-reverse">
              <h1 className="mb-0">{translate('Provide a Better Alternative to Bitcoin')}</h1>
        ...
        <div className="position-relative d-none-sm">
          <img alt="background purple waves" src={require('../static/img/backgrounds/history-purple.svg')} id="history-purple" />
        </div>
            ...
            <div className="timeline">
              <div className="timeline-block mb-20-sm mb-10-until-sm">
                ...
                <div className="timeline-content text-sm-left text-md-right">
                  <div className="d-flex flex-column-reverse">
                    <h2 className="mb-6 h5 h2-sm">{translate('XRP Ledger Development')}</h2>
                  ...
                  <p>
                    ...
                    <a href="https://bitcointalk.org/index.php?topic=10193.0" target="_blank" rel="noopener noreferrer">
                      {translate('about.history.2011.part2', 'May 2011 forum post: “Bitcoin without mining”')}
                    </a>
                    {translate('about.history.2011.part3', ').')}
                  </p>
                  <a
                    className={`btn btn-primary read-more mt-10 ${openSections['section-1'] && 'd-none'}`}
                    onClick={() => toggleSection('section-1')}
                  >
                    {translate('Read More')}
                  </a>
                  <div className={`hidden-section ${openSections['section-1'] && 'show'}`} id="section-1">
                    <p>
                      {translate(
              ...
              <div className="timeline-block mb-20-sm mb-10-until-sm">
                ...
                <div className="timeline-content">
                  <div className="d-flex flex-column-reverse">
                    <h2 className="mb-6 h5 h2-sm">{translate('XRPL Launches its Native Currency, XRP')}</h2>
                  ...
                  <a
                    className={`btn btn-primary read-more mt-10 ${openSections['section-2'] && 'd-none'}`}
                    data-target="section-2"
                    onClick={() => toggleSection('section-2')}
                  >
                    {translate('Read More')}
                  </a>
                  <div className={`hidden-section ${openSections['section-2'] && 'show'}`} id="section-2">
                    <p>
                      {translate(
                    ...
                    <p>{translate('By June 2012, Schwartz, McCaleb, and Britto finished code development, and the Ledger was complete.')}</p>
                    <p>
                      {translate(
              ...
              <div className="timeline-block mb-20-sm mb-10-until-sm">
                ...
                <div className="timeline-content text-sm-left text-md-right">
                  <div className="d-flex flex-column-reverse">
                    <h2 className="mb-6 h5 h2-sm">{translate('OpenCoin Rebranded to Ripple Labs')}</h2>
                  ...
                  <a
                    className={`btn btn-primary read-more mt-10 ${openSections['section-3'] && 'd-none'}`}
                    data-target="section-3"
                    style={{
                      display: openSections['section-3'] ? 'none' : 'inline-block',
                    }}
                    onClick={() => toggleSection('section-3')}
                  >
                    {translate('Read More')}
                  </a>
                  <div className={`hidden-section ${openSections['section-3'] && 'show'}`} id="section-3">
                    <p>
                      {translate(
              ...
              <div className="timeline-block mb-20-sm mb-10-until-sm">
                ...
                <div className="timeline-content">
                  <div className="d-flex flex-column-reverse">
                    <h2 className="mb-6 h5 h2-sm">{translate('XRPL Foundation Launched')}</h2>
                  ...
                  <p>
                    ...
                    <Link to="/community" target="_blank" rel="noopener noreferrer">
