    ...
    <div className="landing page-impact">
      <div className="overflow-hidden">
        <div className="position-relative d-none-sm">
          <img alt="purple waves" src={require('../static/img/backgrounds/community-purple.svg')} className="landing-bg" id="impact-purple" />
        </div>
        <section className="container-new py-26 text-lg-center">
          <div className="p-0 col-lg-8 mx-lg-auto">
            <div className="d-flex flex-column-reverse">
              <h1 className="mb-0">{translate('Today’s Value, Tomorrow’s Vision')}</h1>
              <h6 className="eyebrow mb-3">{translate('XRPL Today, XRPL Tomorrow')}</h6>
            </div>
          </div>
        </section>
        <div className="position-relative d-none-sm">
          <img alt="green waves" src={require('../static/img/backgrounds/home-green.svg')} id="impact-green" />
        </div>
        {/* World map */}
        <section className="container-new py-10">
          <div className="col-sm-10 col-lg-6 offset-md-3 p-10-until-sm pl-0-sm pr-0-sm">
            <h6 className="eyebrow mb-3">{translate('Building for the Future')}</h6>
            <h2 className="h4 h2-sm mb-8">{translate('Consensus protocol is efficient and sustainable')}</h2>
          ...
          <div>
            {/* Large */}
            <div className="col d-none d-lg-block align-self-center">{View}</div>
          </div>
        </section>
        {/* Video sidebar */}
        <section className="container-new py-26">
          <div className="mt-10 card-grid card-grid-2xN">
            ...
            <div className="col ls-none mb-16-sm">
              <h6 className="eyebrow mb-3">{translate('A Sustainable Future')}</h6>
              <h2 className="h4 h2-sm mb-8">{translate('What makes the XRPL sustainable?')}</h2>
              <h5 className="longform mb-10">
                {translate(
        ...
        <section className="container-new py-26">
          <div className="col-md-6 offset-md-3 p-6-sm p-10-until-sm br-8 cta-card">
            <img alt="purple waves" src={require('../static/img/backgrounds/cta-community-purple.svg')} className="cta cta-top-left" />
            <img alt="green waves" src={require('../static/img/backgrounds/cta-calculator-green.svg')} className="cta cta-bottom-right" />
            <div className="z-index-1 position-relative">
              <div className="d-flex flex-column-reverse">
                <h2 className="h4 h2-sm mb-10-until-sm mb-8-sm">{translate('Featured companies & projects running on the XRP Ledger.')}</h2>
                <h6 className="eyebrow mb-3">{translate('Sustainable Projects')}</h6>
              </div>
              <p className="mb-10">
                {translate(
          ...
          <div className="d-flex flex-column flex-lg-row align-items-lg-center mr-lg-4">
            <div className="order-1  mb-4 pb-3 mb-lg-0 pb-lg-0 col-lg-6 px-0 p-lg-3">
              <div className="d-flex flex-column-reverse py-lg-3">
                <h3 className="h4 h2-sm">{translate('How can businesses and developers connect and contribute?')}</h3>
              </div>
                ...
                <div className="col-12 col-lg-6 p-0 pr-3">
                  <div className="px-lg-3 pb-3">
                    ...
                    <div className="pt-3">
                      ...
                      <p>
                        ...
                        <Link to="/blog">{translate('about.impact.blog.ppart2', 'XRPL dev blog ')}</Link>
                        {`${translate(
                  ...
                  <div className="px-lg-3 pb-3 d-lg-none">
                    ...
                    <div className="pt-3">
                      ...
                      <p>
                        ...
                        <Link to="/community/events">{translate('about.impact.events.ppart2', 'meetups, hackathons, and conferences ')}</Link>
                        {`${translate('about.impact.events.ppart3', 'to meet other members of the community.')}`}
                      </p>
                    </div>
                  </div>
                  <div className="px-lg-3 pb-3 pt-lg-5">
                    ...
                    <div className="pt-3">
                      ...
                      <p>
                        ...
                        <a href="https://github.com/XRPLF/xrpl-dev-portal/" target="_blank">
                          {translate('about.impact.code.ppart2', 'Github repositories ')}
                        </a>
                        {`${translate('about.impact.code.ppart3', 'to find blockchain projects to see how you can contribute.')}`}
                      </p>
                    </div>
                  </div>
                  {/* Hide on large */}
                  <div className="px-lg-3 pb-3 d-lg-none">
                    ...
                    <div className="pt-3">
                      ...
                      <p>{translate('about.impact.connect.ppart1', 'Join the conversation on social media using #XRPLCommunity.')}</p>
                    </div>
                  </div>
                </div>
                {/* end col 1 */}
            ...
            <div className="d-lg-none order-3 mt-4 pt-3">
              <Link className="btn btn-primary btn-arrow" target="_blank" to="/resources/contribute-code">
                {translate('Join the Community')}
              </Link>
            </div>
          </div>
