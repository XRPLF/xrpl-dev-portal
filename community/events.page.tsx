...
const events = [
  ...
  },
  {
    ...
    description: 'Smart Contracts, Smarter XRP Ledger! Be the first to learn and build on the upcoming XRP Ledger integration with EVM at ETHDenver!',
    type: 'zone',
  ...
  },
  {
    ...
    description: 'IXH24 is a hackathon with a focus on cryptography and blockchain.',
    type: 'hackathon',
  ...
  },
  {
    ...
    description: "Celebrate blockchain's role in social impact with expert panels, pitches from past Aquarium Residency startups, and networking.",
    type: 'meetup',
  ...
  },
  {
    ...
    description: 'Join Us for a fourth XRPL Town Hall Meeting: Back from APEX!',
    type: 'info',
  ...
  },
  {
    ...
    description: `Calling all blockchain and XRP Ledger enthusiasts in Brussels! Join XRPL Meetups to share knowledge, build real-life connections, and foster communities centered around blockchain and XRP Ledger. We're establishing local "XRPL Hubs" across Europe, and we want you to be a part of it!`,
    type: 'meetup',
  ...
  },
  {
    ...
    description: 'Join Us for the 5th XRPL Town Hall Meeting!',
    type: 'info',
...
export default function Events() {
  ...
  const filteredUpcoming = useMemo(() => {
    return upcoming.filter((event) => upcomingFilters[event.type.split('-')[0]] !== false)
    ...
    <div className="landing page-events">
      <div>
        <div className="position-relative d-none-sm">
          <img alt="orange waves" src={require('../static/img/backgrounds/events-orange.svg')} id="events-orange" />
        </div>
        <section className="text-center py-26">
          <div className="mx-auto text-center col-lg-5">
            <div className="d-flex flex-column-reverse">
              <h1 className="mb-0">{translate('Find the XRPL Community Around the World')}</h1>
        ...
        <section className="container-new py-26">
          <div className="event-hero card-grid card-grid-2xN">
            <div className="pr-2 col">
              <img alt="xrp ledger events hero" src={require('../static/img/events/xrp-community-night.png')} className="w-100" />
            </div>
            <div className="pt-5 pr-2 col">
              <div className="d-flex flex-column-reverse">
                <h2 className="mb-8 h4 h2-sm">{translate('XRP Community Night NYC')}</h2>
                <h6 className="mb-3 eyebrow">{translate('Save the Date')}</h6>
              </div>
              <p className="mb-4">{translate('Join the XRP community in NYC—meet builders, users, and projects innovating on the XRP Ledger.')}</p>
              <div className=" my-3 event-small-gray">{translate('Location: New York, NY')}</div>
              <div className="py-2 my-3 event-small-gray">{translate('November 5, 2025')}</div>
              <div className="d-lg-block">
                <a className="btn btn-primary btn-arrow-out" target="_blank" href="https://lu.ma/g5uja58m?utm_source=xrpleventspage">
        ...
        <section className="container-new py-26" id="upcoming-events">
          <div className="p-0 pb-2 mb-4 d-flex flex-column-reverse col-lg-6 pr-lg-5">
            <h3 className="h4 h2-sm">{translate('Check out meetups, hackathons, and other events hosted by the XRPL Community')}</h3>
            ...
            <div>
              ...
              <div className="form-check form-check-inline">
                <input
                  ...
                  onChange={handleUpcomingFilterChange}
                />
                <label htmlFor="info-upcoming">{translate('Info Session')}</label>
              </div>
            </div>
          </div>
          ...
          <div className="mt-2 row row-cols-1 row-cols-lg-3 card-deck">
            {filteredUpcoming.map((event, i) => (
              <a key={event.name + i} className={`event-card ${event.type}`} href={event.link} style={{}} target="_blank">
                <div
                ...
                <div className="mt-lg-auto event-card-footer d-flex flex-column">
                  <span className="mb-2 d-flex icon icon-location">{event.location}</span>
        ...
        <section className="container-new pt-26" id="past-events">
          <div className="p-0 pb-2 mb-4 d-flex flex-column-reverse col-lg-6 pr-lg-5">
            <h3 className="h4 h2-sm">{translate('Explore past community-hosted events')}</h3>
          ...
          <div className="mt-2 mb-0 row row-cols-1 row-cols-lg-3 card-deck ">
            {filteredPast.map((event, i) => (
              <a key={event.name + i} className="event-card {event.type}" href={event.link} target="_blank">
                <div
                  className="event-card-header"
                  style={{
                    background: `url(${event.image}) no-repeat`,
