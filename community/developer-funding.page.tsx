      ...
      <div>
        ...
        <section className="container-new py-26 text-lg-center">
          <div className="p-0 col-lg-6 mx-lg-auto">
            <div className="d-flex flex-column-reverse">
              <h1 className="mb-0">{translate('XRPL Developer Funding Programs')}</h1>
        ...
        <section className="container-new py-26">
          <div className="p-0 col-lg-6 mx-lg-auto" style={{ maxWidth: 520 }}>
            <div className="d-flex flex-column-reverse">
              <h1 className="mb-0 h4 h2-sm">{translate('Explore funding opportunities for developers and teams')}</h1>
        ...
        <section className="container-new py-26">
          ...
          <div className="d-flex flex-column flex-lg-row align-items-lg-center">
            <div className="order-1 order-lg-2 mb-4 pb-3 mb-lg-0 pb-lg-0 col-lg-6 px-0" style={{ maxWidth: 520 }}>
                ...
                <div className="col-12 col-lg-6 p-0">
                  <div className="px-lg-3 pb-3">
                    ...
                    <div className="pt-3">
                      ...
                      <p>{translate('Software developers and teams building directly on the XRP Ledger')}</p>
                    </div>
                  </div>
                  {/* Hide on large */}
          ...
          <div className="d-flex flex-column flex-lg-row align-items-lg-center mr-lg-4">
            <div className="order-1  mb-4 pb-3 mb-lg-0 pb-lg-0 col-lg-6 px-0 p-lg-3">
              <div className="d-flex flex-column-reverse py-lg-3">
                ...
                <h6 className="eyebrow mb-3">{translate('Fund Your Project')}</h6>
              </div>
              ...
              <div className="d-none d-lg-block py-lg-3">
                <a className="btn btn-primary btn-arrow-out" target="_blank" href="https://xrplgrants.org/">
              ...
              <div className="row align-items-center m-0 funding-list">
                ...
                <div className="col-12 col-lg-6 p-0">
                  <div className="px-lg-3 pb-3">
                    ...
                    <div className="pt-3">
                      <h6 className="mb-3">{translate('Best for')}</h6>
                      <p>{translate('Software developers, teams, and start-ups building directly on the XRP Ledger')}</p>
                    </div>
                  </div>
                  {/* Hide on large */}
                  <div className="px-lg-3 pb-3 d-lg-none">
                    ...
                    <div className="pt-3">
                      <h6 className="mb-3">{translate('Required')}</h6>
                      <p>
                        <span style={{ color: '#7919FF' }}>•</span> {translate('Coding experience')}
                        <br />
                        <span style={{ color: '#7919FF' }}>•</span> {translate('Github repository')}
                        <br />
                        <span style={{ color: '#7919FF' }}>•</span> {translate('Project narrative/description')}
                        <br />
                        <span style={{ color: '#7919FF' }}>•</span> {translate('At least one developer on the core team')}
                        <br />
                        <span style={{ color: '#7919FF' }}>•</span> {translate('Budget and milestones')}
                      </p>
                    </div>
                  </div>
                  <div className="px-lg-3 pb-3 pt-lg-5">
                    ...
                    <div className="pt-3">
                      <h6 className="mb-3">{translate('Level')}</h6>
                      <p>{translate('XRPL intermediate to advanced developers')}</p>
                    </div>
                  </div>
                  {/* Hide on large */}
                  <div className="px-lg-3 pb-3 d-lg-none">
          ...
          <div className="d-flex flex-column flex-lg-row align-items-lg-center">
            <div className="order-1 order-lg-2 mb-4 pb-3 mb-lg-0 pb-lg-0 col-lg-6 px-0" style={{ maxWidth: 520 }}>
              <div className="d-flex flex-column-reverse p-lg-3">
                ...
                <h6 className="eyebrow mb-3">{translate('Advance your project')}</h6>
              </div>
              <p className="p-lg-3 mb-2 longform">
                {translate('12-week program for entrepreneurs building on the XRP Ledger to scale their projects into thriving businesses.')}
              </p>
              <div className="d-none d-lg-block p-lg-3">
                <a className="btn btn-primary btn-arrow" href="https://xrplaccelerator.org/">
              ...
              <div className="row align-items-center m-0 funding-list">
                ...
                <div className="col-12 col-lg-6 p-0">
                  <div className="px-lg-3 pb-3">
                    ...
                    <div className="pt-3">
                      <h6 className="mb-3">{translate('Best for')}</h6>
                      <p>{translate('Start-ups building scalable products on XRPL that can capture a large market opportunity')}</p>
                    </div>
                  </div>
                  {/* Hide on large */}
                  <div className="px-lg-3 pb-3 d-lg-none">
                    ...
                    <div className="pt-3">
                      <h6 className="mb-3">{translate('Required')}</h6>
                      <p>
                        <span style={{ color: '#7919FF' }}>•</span> {translate('Strong founding team')}
                        <br />
                        <span style={{ color: '#7919FF' }}>•</span> {translate('Bold, ambitious vision')}
                        <br />
                        <span style={{ color: '#7919FF' }}>•</span> {translate('Ideally an MVP and monetization strategy')}
                      </p>
                    </div>
                  </div>
                  <div className="px-lg-3 pb-3 pt-lg-5">
                    ...
                    <div className="pt-3">
                      <h6 className="mb-3">{translate('Level')}</h6>
                      <p>
                        <span style={{ color: '#7919FF' }}>•</span> {translate('XRPL advanced developers')}
                        <br />
                        <span style={{ color: '#7919FF' }}>•</span> {translate('Business acumen')}
                      </p>
                    </div>
                  </div>
                  {/* Hide on large */}
                  <div className="px-lg-3 pb-3 d-lg-none">
                    ...
                    <div className="pt-3">
                      <h6 className="mb-3">{translate('Funding Levels')}</h6>
                      <p>{translate('$50,000 (grant) + pitch for venture funding')}</p>
                    </div>
                  </div>
                </div>
                {/* end col 1 */}
        ...
        <div className="position-relative d-none-sm">
          <img alt="orange waves" src={require('../static/img/backgrounds/funding-orange.svg')} id="funding-orange" />
        </div>
      </div>
    </div>
  )
