      ...
      <div>
        <div className="position-relative d-none-sm">
          <img
            ...
            src={require('../static/img/backgrounds/ambassador-purple.svg')}
        ...
        <section className="container-new py-26 text-lg-center">
          ...
          <div className="p-0 col-lg-8 mx-lg-auto">
            ...
            <p className="mt-3 pt-3 col-lg-8 mx-lg-auto p-0">
              {translate('This fall, the ')} <b>{translate('XRPL Student Builder Residency ')}</b>{' '}
              {translate(
                'offers top technical students a 3-week online program (Oct 21 - Nov 13) to develop XRPL projects with expert mentorship. Apply by Oct 14, 2024',
              )}
            </p>
            <p className=" col-lg-8 mx-lg-auto p-0">
              {translate('This program will run from October 21 - November 13 and will be conducted entirely online. ')}
            </p>
            <p className="pb-3 col-lg-8 mx-lg-auto p-0">
              <b>{translate('Applications due October 14, 2024')}</b>
              {translate(' @ 11:59pm PDT')}
            </p>
            <button
              className="btn btn-primary btn-arrow-out"
              onClick={() => window.open('https://share.hsforms.com/1k47bfuX2SL2DKZtZoJzArg4vgrs', '_blank')}
            >
              {translate('Apply for Fall 2024')}
            </button>
          </div>
        </section>
        {/* Current Students */}
          ...
          <div className="d-flex flex-column flex-lg-row align-items-lg-center">
            ...
            <div className="order-lg-1 col-lg-6 px-0 mr-lg-4">
              <div className="row m-0">
                <img
                  alt="Person speaking and person taking photo"
                  src={require('../static/img/ambassadors/developer-hero@2x.png')}
                  className="w-100"
                />
              </div>
            </div>
        ...
        <section className="container-new py-26">
          ...
          <div className="d-flex flex-column flex-lg-row align-items-lg-center mr-lg-4">
            <div className="order-1 order-lg-2  mb-4 pb-3 mb-lg-0 pb-lg-0 col-lg-6 px-0 mr-lg-5">
              ...
              <p className="p-lg-3 mb-2 longform">
                {translate(
                  'Students currently enrolled in an undergraduate or postgraduate program at an accredited college or university are eligible to apply.',
                )}
              </p>
            </div>
            ...
            <div className="carousel-inner">
              <div className="carousel-item active">
                <div className="p-0">
                  <div className="mb-4 p-lg-3">
                    <img
                      alt="I have learned so much through creating programs and connecting with the XRPL community. Im truly grateful for everyone's support along the way and for the opportunity to gain so much knowledge from this expierence"
                      src={require('../static/img/ambassadors/quote1-small.svg')}
                      className="h-100 d-lg-none mb-4"
                    />
                    <img
                      alt="I have learned so much through creating programs and connecting with the XRPL community. Im truly grateful for everyone's support along the way and for the opportunity to gain so much knowledge from this expierence"
                      src={require('../static/img/ambassadors/quote1.svg')}
              ...
              <div className="carousel-item mb-20">
                <div className="p-0">
                  <div className="mb-4 p-lg-3">
                    <img
                      alt="The XRPL Campus Ambassador program really helped broaden my view of the blockchain industry with their learning resource and virtual community. Being an ambassador allowed me to meet industry professionals and likeminded peers which have given me invaluable experiences and insights."
                      src={require('../static/img/ambassadors/quote2-small.svg')}
                      className="h-150 d-lg-none  mb-4"
                    />
                    <img
                      alt="The XRPL Campus Ambassador program really helped broaden my view of the blockchain industry with their learning resource and virtual community. Being an ambassador allowed me to meet industry professionals and likeminded peers which have given me invaluable experiences and insights."
                      src={require('../static/img/ambassadors/quote2.svg')}
                      className="h-100 d-none d-lg-block"
                    />
                    <div className="p-0 col-lg-7 mx-lg-auto">
                      <p className="p-lg-3 mb-2">
                        <strong>Sally Z.</strong>
                        <br />
                        Toronto Metropolitan University
                        <br />
                        Spring 2023 XRPL Campus Ambassador
                ...
                <div className="p-0">
                  <div className="mb-4 p-lg-3">
                    <img
                      ...
                      src={require('../static/img/ambassadors/quote3-small.svg')}
                      className="h-150 d-lg-none  mb-4"
                    />
                    <img
                      alt="Ive had the pleasure over the course of this program to speak with amazing individuals, I encourage you all to reach out to other people in this program and make as many connections as you can. You will quickly find out that by speaking with other people in this cohort you can learn just about anything if you ask the right people."
                      src={require('../static/img/ambassadors/quote3.svg')}
                      className="h-100 d-none d-lg-block"
                    />
                    <div className="p-0 col-lg-7 mx-lg-auto">
                      <p className="p-lg-3 mb-2">
                        <strong>Nick D.</strong>
                        <br />
                        Miami University
                        <br />
                        Spring 2023 XRPL Campus Ambassador
                ...
                <div className="col-12 col-lg-6 p-0 pr-lg-4">
                  ...
                  <div className="px-lg-3 pb-3">
                    ...
                    <div className="p-lg-3 pt-3">
                      ...
                      <p>
                        {translate(
                          'Congrats on your new role! Join the global cohort of Ambassadors and meet with community participants during onboarding.',
                        )}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="p-lg-3 pb-3 d-lg-none">
                    ...
                    <div className="p-lg-3 pt-3">
                      ...
                      <p>
                        {' '}
                        {translate(
                          'Participate in personalized learning and training sessions for Ambassadors on the XRPL and blockchain technology.',
                        )}
                      </p>
                    </div>
                  </div>
              ...
              <div className="row align-items-center m-0">
                <div className="col-12 col-lg-6 p-0 pr-lg-4">
                  <div className="p-lg-3 mb-3 pb-3">
                    ...
                    <div>
                      <h6 className="mb-3">
                        <a className="btn-arrow" href="https://www.meetup.com/pro/xrpl-community/">
                          {translate('MeetUp')}
                        </a>
                      </h6>
                  ...
                  <div className="p-lg-3 mb-3 pb-3">
                    ...
                    <div>
                      <h6 className="mb-3">
                        <a className="btn-arrow" href="https://dev.to/t/xrpl">
                ...
                <div className="col-12 col-lg-6 p-0 pl-lg-4">
                  <div className="p-lg-3 mb-3 pb-3 ">
                    ...
                    <div>
                      <h6 className="mb-3">
                        <a className="btn-arrow" href="https://xrpldevs.org">
                          {translate('Discord')}
                        </a>
                      </h6>
