...
const events = [
  ...
  },
  {
    ...
    description: 'Join the DevRel team at Ripple to learn more about APEX 2024.',
    type: 'ama',
  ...
  },
  {
    ...
    description: "Hello San Francisco XRP Ledger community! We're hosting a meetup soon with a focus on ZK research. Excited to see you soon!",
    type: 'meetup',
  ...
  },
  {
    ...
    description: 'Get ready for an unforgettable evening at the XRPL Meetup NYC!',
    type: 'meetup',
  ...
  },
  {
    ...
    description: 'Collaborate, learn, and connect with fellow blockchain innovators and the Flare Networks team at Harvard.',
    type: 'hackathon',
  ...
  },
  {
    ...
    description: 'Join XRP Seoul 2025, Asia’s largest XRP & Web3 conference, and explore the future of the industry.',
    type: 'conference',
    ...
    <>
      <section className="xrpl-events-section">
        <div className="header-div">
          ...
          <Link className="cd-none-sm btn btn-primary btn-arrow view-all-events-btn" target="_blank" to="/community/events">
        ...
        <Link target="_blank" className="cd-none-lg btn btn-primary btn-arrow view-all-events-btn" to="/community/events">
          {translate('View All Events')}
        </Link>
      </section>
        ...
        <div className="image-container">
          ...
          <div className="center-image-wrapper">
            <img
              ...
              onClick={() => currentEvent && window.open(currentEvent.link, '_blank')}
            />
            <div className="event-info">
              <span className="name">{currentEvent ? currentEvent.name : ''}</span>
...
const CommunityPage: React.FC = () => {
  ...
  return (
    <div className="no-sidebar landing page-community">
      ...
      <section className="text-center" id="community-heading" style={{ position: 'relative' }}>
        <div className="d-lg-block d-none">
          ...
          />
          <img alt="Person speaking at a conference" className="parallax two" src={require('../static/img/community/community-two.png')} />
          <img alt="Person sitting and speaking" className="parallax three" src={require('../static/img/community/community-three.png')} />
          <img
            alt="People chatting"
          ...
          />
          <img alt="Person speaking at Apex" className="parallax five" src={require('../static/img/community/community-five.png')} />
        </div>
        ...
        <div className="mx-auto text-left col-lg-6 text-md-center hero-title">
          <div className="d-flex flex-column-reverse align-items-center sm-align-items-start">
            <img src={require('../static/img/icons/arrow-down.svg')} className="bounce-arrow" alt="Down Arrow" />
        ...
        <table>
          <tbody>
            <tr>
              ...
              <td>{translate('Join the XRPL Discord to connect and network with builders, validators, and cryptocurrency enthusiasts.')}</td>
              <td>
                <a href="https://discord.gg/xrpl" target="_blank" className="text-external-link">
            ...
            <tr>
              ...
              <td>{translate('Follow @RippleXDev on X for the latest updates on the XRP Ledger ecosystem.')}</td>
              <td>
                <a href="https://x.com/RippleXDev" target="_blank" className="text-external-link">
                  <span className="external-link-contribute"></span>
                </a>
              </td>
            </tr>
            ...
            <tr className="final-tr">
              ...
              <td>
                <a href="https://learn.xrpl.org/react-3d-game/" target="_blank" className="text-external-link">
                  <span className="external-link-contribute"></span>
                </a>
              </td>
            </tr>
      ...
      <section className="community-funding">
        <Link target="_blank" className="cd-none-lg btn btn-primary btn-arrow view-all-events-btn get-funding-btn" to="/community/developer-funding/">
          {translate('Get Funding')}
        </Link>
        <div className="stats">
          <div className="stacked-stats">
            <div className="stat">
              <span className="small-text">{translate('funding been awarded')}</span>
            ...
            <div className="stat">
              <span className="small-text">{translate('teams awarded globally')}</span>
          ...
          <div className="stat">
            <span className="small-text">{translate('countries represented')}</span>
        ...
        <div className="funding-section">
          <span className="funding-text">{translate('XRPL Developer Funding')}</span>
          <h2>{translate('Funding Opportunities for Blockchain Businesses')}</h2>
          <p>
            {translate(
          ...
          <Link className="cd-none-sm btn btn-primary btn-arrow view-all-events-btn" target="_blank" to="/community/developer-funding/">
            {translate('Get Funding')}
          </Link>
        </div>
      </section>
      ...
      <section className="community-spotlight-wrapper">
        <div className="community-spotlight">
          <h6 className="funding-text">{translate('XRPL Community Spotlight')}</h6>
          <h2 className="spotlight-subtitle">{translate('Showcase your blockchain project, application, or product')}</h2>
        ...
        <div className="projects-wrapper">
          <div className="project-card top-left">
            <div className="card-image">
              <img className="middle-image" src={require('../static/img/community/blockdaemon.png')} alt="Blockdaemon" />
            </div>
            <div className="card-details">
              ...
              <a href="https://xrpl.org/blog/2023/blockdaemon.html" target="_blank" className="view-project external-link">
          ...
          <div className="project-card bottom-right">
            <div className="card-image">
              <img className="middle-image-two" src={require('../static/img/community/xrp-cafe.png')} alt="XRPCafe" />
            </div>
            <div className="card-details">
              <h6 className="project-title">XRPCafe</h6>
              <p className="project-description">{translate('A premier NFT marketplace dedicated to fostering mass adoption of the XRP Ledger.')}</p>
              <a href="https://xrpl.org/blog/2023/xrpcafe.html" target="_blank" className="view-project external-link">
                {translate('View Project')}
              </a>
            </div>
          </div>
      ...
      <section className="bottom-cards-section bug-bounty">
        <div className="com-card ripplex-bug-bounty">
          ...
          <div className="card-content">
            <h6 className="card-title">{translate('RippleX Bug Bounty Program')}</h6>
            ...
            <p className="card-description">
              ...
              <p className="card-description">
                {translate(
                  'community.index.security.description-1',
        ...
        <div className="com-card">
          ...
          <div className="card-content">
            ...
            <h6 className="card-subtitle pr-bt28">{translate('Report Scams to Safeguard Our Community')}</h6>
            <p className="card-description">
              {translate(
            ...
            <div className="card-links">
              <Link target="_blank" className="com-card-link" to="/community/report-a-scam/">
      ...
      <section className="bottom-cards-section">
        <div className="com-card">
          ...
          <div className="card-content">
            <h6 className="card-title">{translate('Contribute to Consensus')}</h6>
            <h6 className="card-subtitle">{translate('Run an XRP Ledger network node')}</h6>
            <p className="card-description">{translate('Thank you for your interest in contributing to XRP Ledger.')}</p>
            <div className="card-links">
              <Link className="com-card-link" target="_blank" to="/docs/concepts/networks-and-servers/">
                {translate('Networks and Servers')}
              </Link>
              <Link className="com-card-link" target="_blank" to="/docs/infrastructure/configuration/server-modes/run-rippled-as-a-validator/">
                {translate('Join UNL')}
              </Link>
              <Link className="com-card-link" target="_blank" to="/docs/infrastructure/installation/">
                {translate('Install & Configure')}
              </Link>
              <Link className="com-card-link" target="_blank" to="/docs/infrastructure/troubleshooting/">
        ...
        <div className="com-card">
          ...
          <div className="card-content">
            ...
            <h6 className="card-subtitle pr-bt16">{translate('Discover your next career opportunity in the XRPL community')}</h6>
            <p className="card-description">
              {translate('Teams across the XRPL community are looking for talented individuals to help build their next innovation.')}
            </p>
            <div className="card-links">
              <a className="com-card-link" target="_blank" href="https://jobs.xrpl.org/jobs">
        ...
        <div className="com-card">
          ...
          <div className="card-content">
            <h6 className="card-title">{translate('Contribute to XRPL.org')}</h6>
            <h6 className="card-subtitle">{translate('A Community-Driven Resource for All Things XRP Ledger')}</h6>
            <p className="card-description">
              {translate(
            ...
            <div className="card-links">
              <Link className="com-card-link" target="_blank" to="/resources/contribute-documentation/">
