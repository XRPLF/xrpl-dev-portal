/**
 * MaterialDownloadIcon — Arrow above a baseline. Upstream ships the identical
 * drawing again as `file_download`.
 *
 * ---------------------------------------------------------------------------
 ...
 */
export const MaterialDownloadIcon: React.FC<{ className?: string }> = ({
  className = "",
}) => {
  return (
    <svg
