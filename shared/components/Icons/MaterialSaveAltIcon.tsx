/**
 * MaterialSaveAltIcon — Arrow into an open tray. Despite the upstream name,
 * this is the icon most people picture when they say "download".
 *
 * ---------------------------------------------------------------------------
 ...
 */
export const MaterialSaveAltIcon: React.FC<{ className?: string }> = ({
  className = "",
}) => {
  return (
    <svg
