...
_Curated release notes will be posted on this blog and will include updates from every active project. Specifically we will post and link to any new release notes, open bounties, and upcoming features._

_We hope you find these useful! Please let us know if you have feedback in the comments._
...
_Released versions 0.8.2, 0.8.3-rc1, 0.9.0-rc1, 0.9.0-rc2_ 0.9.0-rc2
...
_No major updates_ [**_Open bounties_**](https://www.bountysource.com/trackers/3954022-ripple-charts)
...
**[_Open bounties_](https://www.bountysource.com/trackers/3604734-ripple-trade)**
...
_Released version 1.2.5, 1.3.0-rc2, 1.3.0-rc3, 1.3.0-rc4_ 1.3.0-rc4
