...
_A few days tardy, but better late than never..._ _Curated release notes will be posted on this blog and will include updates from every active project. Specifically we will post and link to any new release notes, open bounties, and upcoming features._ _We hope you find these useful! Please let us know if you have feedback in the comments._
...
\*_No new releases_, major commits included below\*
