...
{% table %}
_ **Existing XRPL-Related Assets Owned or Managed by the XRPL Foundation**
_ **Current Planned Future Actions**
---
_ xrpl.org and its content
_ 1. Transfer of domain ownership 2. Hosting and administrative access 3. Update content and ownership
---
_ XRP trademarks
_ 1. Legal documentation for transfer 2. Protect brand guidelines and usage rights
---
_ UNL (vl.xrplf.org)
_ 1. Transfer operational control to new XRPL Foundation
---
_ Github repositories
_ 1. Transfer repository ownership 2. Update licensing & contribution 3. Notify contributors
---
_ Communication channels (YouTube, X/Twitter, Blog)
_ 1. Transfer of access/ownership 2. Notify stakeholders via joint comms  
 {% /table %}
