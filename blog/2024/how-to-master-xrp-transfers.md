...
With your accounts at the ready, it's time to [send XRP payments using Python](./../../docs/tutorials/payments/send-xrp.md) back and forth. Experience the thrill of moving digital currency with just a few clicks:
