  ...
  return (function () {
  ...
  })()(
    {
      ...
      7: [
            ...
            function makeParserClass(Parser) {
              class TOMLParser extends Parser {
                ...
                errorControlCharInString() {
                  ...
                  return this.error(
                    new TomlError(`Control characters (codes < 0x1f and 0x7f) are not allowed in strings, use ${displayCode} instead`),
                  )
                }
        ...
        { './create-date.js': 1, './create-datetime-float.js': 2, './create-datetime.js': 3, './create-time.js': 4, './parser.js': 6 },
      ],
      8: [
        function (require, module, exports) {
          'use strict'
      ...
      9: [
        ...
        { './lib/toml-parser.js': 7, './parse-pretty-error.js': 8 },
      ],
    },
    {},
    [9],
