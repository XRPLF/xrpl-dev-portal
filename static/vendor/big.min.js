...
!(function (e) {
  ...
  function t(e, r, t, n) {
    ...
    if (((i = e.e), (t = (s = e.c.join('')).length), 2 != r && (1 == r || (3 == r && n <= i) || i <= o.NE || i >= o.PE)))
  ...
  ;((l.abs = function () {
    ...
    (l.mod = function (e) {
      ...
      return (
        ...
        (t.s = i),
        (e.s = s),
        r ? new n(t) : ((i = n.DP), (s = n.RM), (n.DP = n.RM = 0), (t = t.div(e)), (n.DP = i), (n.RM = s), this.minus(t.times(e)))
      )
    }),
    (l.plus = l.add =
      function (e) {
          ...
          (e =
            0 === (s = Math.sqrt(n + '')) || s === 1 / 0
              ? (((r = n.c.join('')).length + o) & 1 || (r += '0'),
                (o = (((o + 1) / 2) | 0) - (o < 0 || 1 & o)),
                new i(((s = Math.sqrt(r)) == 1 / 0 ? '1e' : (s = s.toExponential()).slice(0, s.indexOf('e') + 1)) + o))
              : new i(s)).e + (i.DP += 4);
        (t = e), (e = f.times(t.plus(n.div(t)))), t.c.slice(0, o).join('') !== e.c.slice(0, o).join('');
      );
          ...
          : (function (e, r) {
              ...
              for (
                e.s = '-' == r.charAt(0) ? ((r = r.slice(1)), -1) : 1,
                  ...
                  0 < (n = r.search(/e/i)) ? (t < 0 && (t = n), (t += +r.slice(n + 1)), (r = r.substring(0, n))) : t < 0 && (t = r.length),
                  i = r.length,
                  n = 0;
                n < i && '0' == r.charAt(n);
              )
