...
onCurrentRouteLoaded(() => {
  ...
  $('#get-tx-button').click(async function (event) {
    ...
    const earliestLedgerVersion = parseInt($('#interactive-wait .earliest-ledger-version').text(), 10)
    const lastLedgerSequence = parseInt($('#interactive-wait .lastledgersequence').text(), 10)
