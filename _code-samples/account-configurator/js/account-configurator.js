  ...
  if (!document.getElementById('is').checked) {
    ...
    if (signer1AccountField.value != '') {
      my_signers = {
        ...
        SignerEntries: [
          { SignerEntry: { Account: signer1AccountField.value, SignerWeight: parseInt(signer1WeightField.value) } },
          { SignerEntry: { Account: signer2AccountField.value, SignerWeight: parseInt(signer2WeightField.value) } },
          { SignerEntry: { Account: signer3AccountField.value, SignerWeight: parseInt(signer3WeightField.value) } },
        ],
      }
