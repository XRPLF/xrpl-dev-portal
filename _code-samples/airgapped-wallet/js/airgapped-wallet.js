...
createWallet = function () {
  ...
  console.log('XRP Wallet Credentials ' + 'Wallet Address: ' + address + 'Seed: ' + seed)
...
main = async function () {
  ...
  if (menu === 1) {
    const { password, xrpAmount, destinationAddress, accountSequence, ledgerSequence } = await prompt.get([
      {
        name: 'password',
