import { isoTimeToRippleTime, rippleTimeToISOTime, isValidClassicAddress } from 'xrpl'
...
export function credentialToXrpl(cred) {
  ...
  return {
    ...
    expiration: cred.expiration ? isoTimeToRippleTime(cred.expiration) : undefined,
  }
}
