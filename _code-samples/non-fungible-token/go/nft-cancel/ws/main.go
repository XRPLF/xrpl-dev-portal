...
func main() {
	...
	if responseMint.Meta.NFTokenID == nil {
		fmt.Println("nftoken_id not found in metadata")
		return
	}
	nftokenID1 := *responseMint.Meta.NFTokenID
	...
	if responseMint2.Meta.NFTokenID == nil {
		fmt.Println("nftoken_id not found in metadata")
		return
	}
	nftokenID2 := *responseMint2.Meta.NFTokenID
