...
async function createOffer() {
  ...
  if (standbyTakerGetsCurrencyField.value == 'XRP') {
    ...
    takerGetsString =
      '{"currency": "' +
      standbyTakerGetsCurrencyField.value +
      '",\n' +
      '"issuer": "' +
      standbyTakerGetsIssuerField.value +
      '",\n' +
      '"value": "' +
      standbyTakerGetsValueField.value +
      '"}'
  ...
  if (standbyTakerPaysCurrencyField.value == 'XRP') {
    ...
    takerPaysString =
      '{"currency": "' +
      standbyTakerPaysCurrencyField.value +
      '",\n' +
      '"issuer": "' +
      standbyTakerPaysIssuerField.value +
      '",\n' +
      '"value": "' +
      standbyTakerPaysValueField.value +
      '"}'
...
async function oPcreateOffer() {
  ...
  if (operationalTakerGetsCurrencyField.value == 'XRP') {
    ...
    takerGetsString =
      '{"currency": "' +
      operationalTakerGetsCurrencyField.value +
      '",\n' +
      '"issuer": "' +
      operationalTakerGetsIssuerField.value +
      '",\n' +
      '"value": "' +
      operationalTakerGetsValueField.value +
      '"}'
    takerGets = JSON.parse(takerGetsString)
  }
  ...
  if (operationalTakerPaysCurrencyField.value == 'XRP') {
    ...
    takerPaysString =
      '{"currency": "' +
      operationalTakerPaysCurrencyField.value +
      '",\n' +
      '"issuer": "' +
      operationalTakerPaysIssuerField.value +
      '",\n' +
      '"value": "' +
      operationalTakerPaysValueField.value +
      '"}'
    takerPays = JSON.parse(takerPaysString)
  }
