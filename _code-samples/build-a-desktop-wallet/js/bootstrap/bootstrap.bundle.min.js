...
!(function (t, e) {
  ...
  ;(P.on(document, 'click.bs.collapse.data-api', '[data-bs-toggle="collapse"]', function (e) {
    ...
    t.find(s).forEach((t) => {
      ...
      let n
      ;(e
        ? (null === e._parent && 'string' == typeof i.parent && ((e._config.parent = i.parent), (e._parent = e._getParent())), (n = 'toggle'))
        : (n = i),
  ...
  var Nt = {
      ...
      fn: function (t) {
        ...
        if (o && r) {
          var h = (function (t, e) {
              return St(
                'number' != typeof (t = 'function' == typeof t ? t(Object.assign({}, e.rects, { placement: e.placement })) : t) ? t : It(t, rt),
              )
            })(s.padding, i),
            d = bt(o),
            u = 'y' === l ? it : ot,
        ...
        for (
          var s = i.mainAxis,
            ...
            v = [g].concat(b).reduce(function (t, i) {
              return t.concat(
                'auto' === gt(i) ? Zt(e, { placement: i, boundary: h, rootBoundary: d, padding: c, flipVariations: p, allowedAutoPlacements: m }) : i,
              )
            }, []),
            y = e.rects.reference,
            w = e.rects.popper,
