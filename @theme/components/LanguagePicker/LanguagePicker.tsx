...
export function LanguagePicker(props: LanguagePickerProps): JSX.Element | null {
  ...
  const languagePickerButton = <Button icon={<GlobalOutlinedIcon color="--button-content-color" />} variant="text" size="medium" />
  ...
  return (
    <LanguageDropdown triggerEvent="click" placement={props.placement} alignment={props.alignment} trigger={languagePickerButton}>
...
const LanguageDropdown = styled(Dropdown).attrs(() => ({
  ...
  --dropdown-menu-item-separator-padding-top: var(--language-picker-dropdown-item-separator-padding-top);
  --dropdown-menu-item-separator-padding-bottom: var(--language-picker-dropdown-item-separator-padding-bottom);
  ...
  --dropdown-menu-item-separator-border-color: var(--language-picker-dropdown-item-separator-border-color);
