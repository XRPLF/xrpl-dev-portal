...
| `hotwallet`    | String or Array            | _(Optional)_ An operational address to exclude from the balances issued, or an array of such addresses. |
...
| `assets`               | Object                    | _(Omitted if empty)_ Total amounts held that are issued by others. In the recommended configuration, the issuing address should have none. |
