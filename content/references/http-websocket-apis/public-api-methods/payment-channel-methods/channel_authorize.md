...
| Field | Type | Description |
|-------|------|-------------|
| `signature` | String | The signature for this claim, as a hexadecimal value. To process the claim, the destination account of the payment channel must send a [PaymentChannelClaim transaction](../../../protocol/transactions/types/paymentchannelclaim.md) with this signature, the exact Channel ID, XRP amount, and public key of the channel. |
