...
- [`xchain_claim_id`](#get-xchainclaimid-object)
- [`xchain_create_account_claim_id`](#get-xchaincreateaccountclaimid-object)
...
Retrieve a `Bridge` object which connects a locking chain and an issuing chain. Can be provided as string (object ID of the Bridge) or as an object.  _(Added by the in-development Sidechains feature)_ :not_enabled:
...
### Get XChainClaimID Object

Retrieve a `XChainClaimID` object. Can be provided as string (object ID of the cross-chain claim) or as an object.  _(Added by the in-development Sidechains feature)_ :not_enabled:
...
### Get XChainCreateAccountClaimID Object
