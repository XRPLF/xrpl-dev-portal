...
| `manifest` | String | _(May be omitted)_ The public "manifest" corresponding to this validator's configured token, serialized to binary and then encoded in base64. This field does not contain any private information. |
