...
* `ledger_header` - Use the [ledger method](../public-api-methods/ledger-methods/ledger.md) instead.
...
* `wallet_seed` - Use the [wallet_propose method](key-generation-methods/wallet_propose.md) instead.

The [validation_seed method](server-control-methods/validation_seed.md) has been removed since `rippled` v0.29.1.
