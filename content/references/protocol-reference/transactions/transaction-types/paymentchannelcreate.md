...
| `PublicKey`      | String    | Blob              | To generate the public key, use the source account's private key (secret) and encrypt it with the SHA-512 standard. The first 66 characters of the 128 characters long hash will be your public key. <!-- STYLE_OVERRIDE: will --> |
