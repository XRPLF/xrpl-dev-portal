...
| `ledger_hash`                 | String    | Hash256           | The [SHA-512Half](../data-types/basic-data-types.md#hashes) of this ledger version. This serves as a unique identifier for this ledger and all its contents. |
| `account_hash`                | String    | Hash256           | The [SHA-512Half](../data-types/basic-data-types.md#hashes) of this ledger's state tree information. |
...
| `total_coins`                 | String    | UInt64            | The total number of [drops of XRP](../data-types/basic-data-types.md#specifying-currency-amounts) owned by accounts in the ledger. This omits XRP that has been destroyed by transaction fees. The actual amount of XRP in circulation is lower because some accounts are "black holes" whose keys are not known by anyone. |
| `transaction_hash`            | String    | Hash256           | The [SHA-512Half](../data-types/basic-data-types.md#hashes) of the transactions included in this ledger. |
