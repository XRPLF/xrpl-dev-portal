...
| `temCANNOT_PREAUTH_SELF`      | The sender of the [DepositPreauth transaction](../types/depositpreauth.md) was also specified as the account to preauthorize. You cannot preauthorize yourself. |
