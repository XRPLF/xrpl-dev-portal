...
If the transaction cannot create _all_ of the requested Tickets (either due to the 250-Ticket limit or the [owner reserve](../../../../concepts/accounts/reserves.md)), it fails and creates no Tickets. To look up how many Tickets an account currently owns, use the [account_info method](../../../http-websocket-apis/public-api-methods/account-methods/account_info.md) and check the `account_data.TicketCount` field.
