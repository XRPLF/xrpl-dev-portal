...
// import { allCodeSamples } from "./filterCodeSamples.js";

// const code_samples = all_code_samples() ;
// const codeSamples = allCodeSamples();
const lang_icons = {
      ...
      <div className="">
        <section className="py-26">
          <div className="col-lg-8 mx-auto text-lg-center">
            ...
            <a className="mt-12 btn btn-primary btn-arrow">
              Submit Code Samples
            </a>
          </div>
        </section>
        ...
        <section className="container-new py-26">
          ...
          <div className="row col-12  card-deck mt-10" id="code-samples-deck">
            <div className="row col-md-12 px-0" id="code_samples_list">
              {/* { code_samples.map(card => (
                <a className="card cardtest col-12 col-lg-5 $$ for lang in card.langs $$ lang_$$lang$$ )) } " href={target.github_forkurl + "/tree/{target.github_branch}/{card.href}"}>
                    <div className="card-header">
                        $$ for lang in card.langs $$
                        <span className="circled-logo"><img alt="$$lang$$" src={require("$$lang_icons[lang]$$")} /></span>
                        )) }
                    </div>
        ...
        <section className="container-new py-26">
          <div>
            <div className="d-flex flex-column">
              <h3 className="h4 h2-sm pb-4">
                {translate("Contribute Code Samples")}
              </h3>
              <h6 className="eyebrow mb-20">
                {translate(
                  "Help the XRPL community by submitting your<br /> own code samples"
                )}
              </h6>
            </div>
            <div className="row pl-4">
              <div className=" col-lg-3 pl-4 pl-lg-0 pr-4 contribute  dot contribute_1">
                ...
                <p className="pb-4">
                  Fork the{" "}
                  <a href="https://github.com/XRPLF/xrpl-dev-portal">xrpl-dev-portal repo</a>.
              ...
              <div className=" col-lg-3 pl-4 pl-lg-0 pr-4 contribute  dot contribute_2">
                ...
                <p className="pb-4">
                  Add your sample code to the{" "}
                  <code>content/_code-samples/</code> folder. Be sure to include
                  a <code>README.md</code> that summarizes what it does and
              ...
              <div className=" col-lg-3 pl-4 pl-lg-0 pr-2 contribute  dot contribute_4 mb-4">
                ...
                <p className="pb-0 mb-0">
                  ...
                  review your submission and suggest changes if necessary. If
                  the code sample is helpful, it’ll be merged and added to
                  XRPL.org!
                </p>
              </div>
            </div>
