...
If a pathfinding request was successfully closed, the response follows the same format as the initial response to [`path_find create`](#path-find-create). If there was no outstanding pathfinding request, an error is returned instead.
