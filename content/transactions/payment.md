...
The [`delivered_amount`](reference-transaction-results.html#delivered-amount) field of a payment's metadata indicates the amount of currency actually received by the destination account.
