      ...
      <section className="container-fluid pt-3 p-md-3">
        ...
        <div className="content">
            ...
            <div className="form-check" key={"network-" + net.shortname}>
                <input onClick={() => setSelectedFaucet(net)} className="form-check-input" type="radio" name="faucet-selector" id={net.id} defaultValue={net.faucet} data-jsonrpcurl={net.jsonrpc_url} data-wsurl={net.ws_url} data-shortname={net.shortname} defaultChecked={selectedFaucet.shortname == net.shortname} />
