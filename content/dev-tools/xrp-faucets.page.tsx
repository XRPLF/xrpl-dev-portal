  ...
  return (
    ...
    <div className="content">
        ...
        <div className="form-check">
            {/* TODO: Figure out why this line is borked - Jackson -> <input 1 onclick="document.getElementById('generate-creds-button').innerHTML='Generate {net.shortname} credentials'" className="form-check-input" type="radio" name="faucet-selector" id={net.id} defaultValue={net.faucet} data-jsonrpcurl={net.jsonrpc_url} data-wsurl={net.ws_url} data-shortname={net.shortname} $$ if loop.index="=" checked$$ endif /> */}
        ...
        <div className="btn-toolbar" role="toolbar" aria-label="Button">
            <button id="generate-creds-button" className="btn btn-primary mr-2 mb-2">Generate Testnet credentials</button>
        </div>{/*/.btn-toolbar*/}
