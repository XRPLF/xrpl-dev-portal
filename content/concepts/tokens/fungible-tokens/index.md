...
3. When you acquire more of that token by [cashing a Check](../../payment-types/checks.md). (_Requires the [CheckCashMakesTrustLine amendment](../../../resources/known-amendments.md#checkcashmakestrustline)_)
