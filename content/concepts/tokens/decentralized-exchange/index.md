...
- **References:**
    - [account_offers method](../../../references/http-websocket-apis/public-api-methods/account-methods/account_offers.md) to look up Offers placed by an account
    - [book_offers method](../../../references/http-websocket-apis/public-api-methods/path-and-order-book-methods/book_offers.md) to look up Offers to buy or sell a given currency pair
    - [OfferCreate transaction](../../../references/protocol/transactions/types/offercreate.md) to place a new Offer or replace an existing Offer
    - [OfferCancel transaction](../../../references/protocol/transactions/types/offercancel.md) to cancel an existing Offer
    - [Offer object](../../../references/protocol/ledger-data/ledger-entry-types/offer.md) for the data structure of passive Offers in the ledger
    - [DirectoryNode object](../../../references/protocol/ledger-data/ledger-entry-types/directorynode.md) for the data structure that tracks all the Offers for a given currency pair and exchange rate.
