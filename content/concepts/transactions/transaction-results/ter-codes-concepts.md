---
html: ter-codes-concepts.html
parent: transaction-results-concepts.html
blurb: ter code definitions.
labels:
  - Transactions
---
# ter Codes
...
**Caution:** Transactions with `ter` codes are not applied the current ledger and cannot cause any changes to the XRP Ledger state. However, a transaction that provisionally failed may still succeed or fail with a different code after being automatically reapplied. For more information, see [Finality of Results](finality-of-results.html).
