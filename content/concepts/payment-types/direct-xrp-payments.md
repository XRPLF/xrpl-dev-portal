...
1. The sender creates a [Payment transaction](../../references/protocol/transactions/types/payment.md), which defines the parameters of the payment. The transaction is a direct XRP payment if XRP is the currency sent and received.
...
- **References:**
    ...
    - [account_info method](../../references/http-websocket-apis/public-api-methods/account-methods/account_info.md) - for checking XRP balances
