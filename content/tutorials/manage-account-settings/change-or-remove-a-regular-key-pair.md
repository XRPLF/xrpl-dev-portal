...
Here's an example error response for an [AccountSet transaction](../../references/protocol/transactions/types/accountset.md) signed using the regular private key removed by the `SetRegularKey` transaction above.
