...
The following code sample shows how to send an [AccountSet transaction](../../references/protocol/transactions/types/accountset.md) to enable the recommended cold address settings:
...
The following code sample shows how to send an [AccountSet transaction](../../references/protocol/transactions/types/accountset.md) to enable the recommended hot address settings:
...
To create a trust line, send a [TrustSet transaction](../../references/protocol/transactions/types/trustset.md) from the **hot address** with the following fields:
...
The following code sample shows how to send a [TrustSet transaction](../../references/protocol/transactions/types/trustset.md) from the hot address, trusting the issuing address for a limit of 1 billion FOO:
...
The following code sample shows how to send a [Payment transaction](../../references/protocol/transactions/types/payment.md) to issue 88 FOO from the cold address to the hot address:
...
Use the [account_lines method](../../references/http-websocket-apis/public-api-methods/account-methods/account_lines.md) to look up the balances from the perspective of the holder. This lists each trust line along with its limit, balance, and settings.

Use the [gateway_balances method](../../references/http-websocket-apis/public-api-methods/account-methods/gateway_balances.md) to look up balances from the perspective of a token issuer. This provides a sum of all tokens issued by a given address.
