...
When you want to withdraw liquidity from the AMM, you can use [AMMDeposit](../../references/protocol/transactions/types/ammdeposit.md) to cash in your LP Tokens to receive a share of the AMM's assets. You can also use LP Tokens like any other tokens in the XRP Ledger, which means you can trade them, use them in payments, or even deposit them in another AMM.

However, you should keep an eye on market conditions, and use tools like [AMMBid](../../references/protocol/transactions/types/ammbid.md) and [AMMVote](../../references/protocol/transactions/types/ammvote.md) to insulate yourself from losses due to changes in the relative value of the two assets in the pool.
