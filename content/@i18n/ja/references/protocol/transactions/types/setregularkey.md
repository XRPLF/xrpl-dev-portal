...
セキュリティを強化するために[マルチシグ](../../../../concepts/accounts/multi-signing.md)を使用できますが、マルチシグを使用する場合には[トランザクションコスト](../../../../concepts/transactions/transaction-cost.md)および[準備金](../../../../concepts/accounts/reserves.md)に追加のXRPが必要となります。
