...
| `WalletLocator` | 文字列    | Hash256       | （省略可）任意の16進数データ。これは署名者を識別するため、または他の関連する目的のために使用することができます。[ExpandedSignerList amendment](../../../../resources/known-amendments.md#expandedsignerlist)により追加されました。 |
