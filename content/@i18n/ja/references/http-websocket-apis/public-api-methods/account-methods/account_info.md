...
応答は[標準フォーマット](../../api-conventions/response-formatting.md)に従い、要求されたアカウントとそのデータ、アカウントの適用先レジャーが結果として表示されます。以下のフィールドが含まれます。
...
| `account_flags`        | オブジェクト | アカウントの`Flags`フィールドに基づく、アカウントのフラグ情報(下記参照)。 [新規: rippled 1.11.0](https://github.com/XRPLF/rippled/releases/tag/1.11.0 "BADGE_BLUE") |
