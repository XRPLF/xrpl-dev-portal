...
| `Field`        | 型   | 説明                                        |
|:---------------|:-------|:---------------------------------------------------|
| `ledger_index` | 数値 | _（省略可）_[レジャーインデックス](basic-data-types.html#レジャーインデックス)により指定されたレジャーを取得します。 |
| `ledger_hash`  | 文字列 | _（省略可）_ 識別用[ハッシュ](basic-data-types.html#ハッシュ)により指定されたレジャーを取得します。 |
...
| `Field`                     | 型             | 説明                 |
|:----------------------------|:-----------------|:----------------------------|
| `hash`                      | 文字列           | （省略される場合があります）要求されるレジャーの[ハッシュ](basic-data-types.html#ハッシュ)（サーバーがこのハッシュを認識している場合）。 |
