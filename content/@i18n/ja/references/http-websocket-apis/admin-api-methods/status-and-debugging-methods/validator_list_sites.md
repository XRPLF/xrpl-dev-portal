...
`validator_list_sites`コマンドは、バリデータリストを処理するサイトのステータス情報を返します。[新規: rippled 0.80.1](https://github.com/XRPLF/rippled/releases/tag/0.80.1 "BADGE_BLUE")

*`validator_list_sites`要求は、権限のないユーザーは実行できない[管理メソッド](../index.md)です。*
