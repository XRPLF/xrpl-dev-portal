...
**Gatewayd is currently unsupported.** Gatewayd is undergoing a major restructuring, and is not supported at this time. You may use the current, in-development version at your own risk. For enterprise-class integrations, we recommend that you use [Ripple-REST](ripple-rest.html) instead at this time.
