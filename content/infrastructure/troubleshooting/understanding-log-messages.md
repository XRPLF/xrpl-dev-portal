...
3. The time zone indicator `UTC`. (Log dates are always in UTC.) [New in: rippled 1.5.0](https://github.com/XRPLF/rippled/releases/tag/1.5.0 "BADGE_BLUE")
...
This indicates that your server is having trouble requesting specific ledger data from its peers. If the [ledger index](../../references/protocol/data-types/basic-data-types.md#ledger-index) is much lower than the most recent validated ledger's index as reported by the [server_info method](../../references/http-websocket-apis/public-api-methods/server-info-methods/server_info.md), this probably indicates that your server is downloading a [history shard](../configuration/data-retention/history-sharding.md).
