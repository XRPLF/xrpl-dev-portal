...
[conditionとfulfillmentの生成](../../tutorials/tasks/use-specialized-payment-types/use-escrows/send-a-conditionally-held-escrow.md#1-generate-condition-and-fulfillment)をご覧ください。
