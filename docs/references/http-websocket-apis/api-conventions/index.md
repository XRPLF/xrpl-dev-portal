...
This section describes data types and formats of the HTTP APIs (JSON-RPC and WebSocket) as implemented in [the `xrpld` server](../../../concepts/networks-and-servers/index.md).
