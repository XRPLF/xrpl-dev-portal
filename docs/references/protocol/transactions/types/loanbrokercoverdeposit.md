...
| `tecFROZEN`              | The asset is globally frozen, or its trust line is frozen — either a regular or a deep freeze — for the depositing account or for the `LoanBroker` pseudo-account. {% amendment-disclaimer name="fixCleanup3_3_0" mode="updated" /%} |
| `tecLOCKED`              | The MPT asset is globally locked, or locked for the depositing account or for the `LoanBroker` pseudo-account. {% amendment-disclaimer name="fixCleanup3_3_0" mode="updated" /%} |
