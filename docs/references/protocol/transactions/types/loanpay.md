...
| `tecNO_PERMISSION` | The transaction lacks the required permissions. This can occur when:<ul><li>The account submitting the transaction isn't the borrower on the loan.</li><li>The loan doesn't permit overpayments. {% amendment-disclaimer name="fixCleanup3_1_3" /%}</li></ul> |
