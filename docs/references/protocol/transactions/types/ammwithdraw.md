...
| `tecFROZEN`             | A token being withdrawn is globally [frozen](../../../../concepts/tokens/fungible-tokens/freezes.md), the AMM's trust line for it is frozen, or the sender's trust line for it is [deep frozen](../../../../concepts/tokens/fungible-tokens/deep-freeze.md). A regular freeze on the sender alone does not cause this error, and the issuer of a token can always withdraw that token. {% amendment-disclaimer name="fixCleanup3_3_0" mode="updated" /%} |
