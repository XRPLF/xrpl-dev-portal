...
| [`Domain`](#domain) | String        | Blob              | The domain that owns this account, as a string of hex representing the ASCII for the domain in lowercase. {% source-link name="Cannot be more than 256 bytes in length." path="include/xrpl/protocol/Protocol.h#L98" /%} |
