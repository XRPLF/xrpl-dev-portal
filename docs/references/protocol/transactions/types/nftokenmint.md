...
If you want to issue an NFT for another account there are two things you must do. Given that _Account A_ is your account and _Account B_ is the account for which you want to mint a NFToken:

1. Set the `NFTokenMinter` account setting on _Account B_ to be _Account A_. (This says that _Account B_ trusts _Account A_ to create NFTs on their behalf.)
