...
| `temBAD_CIPHERTEXT`           | The confidential [Multi-Purpose Token (MPT)](../../../../concepts/tokens/fungible-tokens/multi-purpose-tokens.md) transaction contained invalid ciphertext. {% amendment-disclaimer name="ConfidentialTransfer" /%} |
