...
|:---------------------|:---------------------|:------------------|:-----------------|
| `Account`            | String - [Address][] | AccountID         | Yes       | The unique address of the [account](../../../concepts/accounts/index.md) that initiated the transaction. |
...
| `Fee`                | String - Number      | Amount            | Yes; [auto-fillable][] | Integer amount of XRP, in drops, to be destroyed as a cost for distributing this transaction to the network. Some transaction types have different minimum requirements. See [Transaction Cost][] for details. |
...
| [`Memos`](#memos-field) | Array of Objects  | Array             | No        | Additional arbitrary information used to identify this transaction. |
