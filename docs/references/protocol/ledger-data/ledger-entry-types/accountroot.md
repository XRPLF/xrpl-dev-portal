...
| `Sponsor`                     | String    | AccountID         | No        | The sponsor paying the account reserve for this account. {% amendment-disclaimer name="Sponsor" /%} |
| `SponsoredOwnerCount`         | Number    | UInt32            | No        | The number of objects this account owns that are sponsored by another account. {% amendment-disclaimer name="Sponsor" /%} |
| `SponsoringAccountCount`      | Number    | UInt32            | No        | The number of accounts this account is sponsoring the account reserve for. {% amendment-disclaimer name="Sponsor" /%} |
| `SponsoringOwnerCount`        | Number    | UInt32            | No        | The number of objects this account is sponsoring the reserve for. {% amendment-disclaimer name="Sponsor" /%} |
