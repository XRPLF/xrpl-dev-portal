...
This tutorial shows how to create a [permissioned domain](../../concepts/tokens/decentralized-exchange/permissioned-domains.md), which can be used to grant access to specific other features like [Permissioned DEXes](../../concepts/tokens/decentralized-exchange/permissioned-dexes.md) and [Single Asset Vaults](../../concepts/tokens/single-asset-vaults.md). 
