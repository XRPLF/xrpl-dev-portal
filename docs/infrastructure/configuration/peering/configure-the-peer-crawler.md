...
seo:
    description: Configure how much information your xrpld server reports publicly about its status and peers.
labels:
  - Core Server
  - Security
---
