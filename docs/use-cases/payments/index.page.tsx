...
export const frontmatter = {
  seo: {
    ...
    description:
      'The XRP Ledger Payments Suite is a payments solution for use cases including stablecoin payments, cross-border remittance, B2B payment rails, and merchant settlement.',
  },
}
...
const PaymentsPage: React.FC = () => {
  ...
  const battleTestedProjects = [
    ...
    },
    {
      ...
      description:
        'Ripple Payments enables crypto companies, payment service providers and fintech to facilitate real-time cross-border payments using stablecoins, digital assets and local currencies — with XRPL as a foundational transaction layer.',
      buttonText: 'Case Study',
    },
    {
      id: 'friipay',
  ...
  const paymentsResourcesCards = [
    ...
    },
    {
      ...
      description:
        'Stay ahead of the curve with the latest developments in XRPL Payments by joining the Developer Discord and signing up for the XRPL Community Newsletter.',
      links: [
        {
    ...
    <main className="use-case-payments">
      <section className="use-case-payments__hero">
        ...
        <div className="text-content">
          <h6 className="eyebrow mb-3 text-large">{translate('Payments')}</h6>
          <h2 className="h4 h2-sm mb-10">{translate('Payments Suite')}</h2>
          <p className="mb-10">
            {translate('Helping fintechs and payment providers move money fast, globally, and at low cost - all through simple APIs.')}
          </p>
        </div>
      </section>
        ...
        <div className="developer-tools">
          <div className="">
            <header className="developer-tools__header text-center">
              <h2 className="developer-tools__title">{translate('Flexible Integration: DIY or Partner-Led')}</h2>
            </header>
            <div className="row">
              <div className="col-lg-6">
                <div className="integration-column">
                  <h3 className="integration-column__title">{translate('Build It Yourself')}</h3>
                  <p className="integration-column__subtitle">{translate('Ideal for seasoned teams with crypto experience')}</p>
              ...
              <div className="col-lg-6">
                <div className="integration-column">
                  <h3 className="integration-column__title">{translate('Work with a Partner')}</h3>
                  <p className="integration-column__subtitle">{translate('Ideal for regulated institutions')}</p>
                  <ul className="developer-tools__list">
                    <FeatureItem link="https://discord.com/invite/KTNmhJDXqa" title="Connect with the Community" />
                  </ul>
                </div>
              </div>
            </div>
