...
You can learn more in the tutorial [Assign an Authorized Minter](../../tutorials/tokens/nfts/assign-an-authorized-minter-js.md).
...
To mint your first NFTs on behalf of another account, see [Authorizing Another Account to Mint Your NFTs](../../tutorials/tokens/nfts/assign-an-authorized-minter-js.md).
...
You transfer NFTs by creating a sell offer or accepting a buy offer. See [Transfer NFTokens](../../tutorials/tokens/nfts/transfer-nfts-js.md).

You can sell your NFTs in an auction format. See [Running an NFT Auction](../../concepts/tokens/nfts/running-an-nft-auction.md).

You can act as a broker, connecting sellers with bidders, completing the transfer and keeping a percentage of the purchase price. See [Broker a NFToken sale](../../tutorials/tokens/nfts/broker-an-nft-sale-js.md).
...
The most straightforward payment for XRPL NFTs is XRP. For examples of selling and buying NFTs using XRP, see [Transfer NFTokens](../../tutorials/tokens/nfts/transfer-nfts-js.md).

![Checkout](/docs/img/uc-nft-checkout.png)

For trade in other currencies, you can leverage the DEX to accept and convert issued currencies of all kinds. See [Trade in the Decentralized Exchange](../../tutorials/defi/dex/trade-in-the-decentralized-exchange.md#trade-in-the-decentralized-exchange).
