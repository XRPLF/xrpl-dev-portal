...
const benefitsData = [
  ...
  },
  {
    ...
    description: 'Automatically check investor credentials, control who can transfer assets, and keep a full record of every transaction. ',
  },
  {
    iconClass: 'delegated-token-management',
    title: 'Delegated Token Management',
    description: 'Use a robust permission system to let trusted third parties manage the token on your behalf.',
  },
]
      ...
      <div className="rwa-tokenization">
        <div className="container max-w-1150">
          <header className="rwa-header">
            <h2 className="rwa-title">{translate('Defining Features on XRPL')}</h2>
          </header>
          ...
          <div className="row">
            <div className="col-lg-6">
              <header className="developer-tools__header">
                <h2 className="developer-tools__title">{translate('Developer Tools & APIs')}</h2>
              ...
              <ul className="developer-tools__list">
                {features.map((feature, index) => (
                  <FeatureItem key={index} link={feature.link} title={feature.title} />
                ))}
              </ul>
            </div>
            <div className="col-lg-6 m-h-300">
              <div className="developer-tools__image" role="img" aria-label="Developer tools illustration"></div>
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <section className="token-events-wrapper">
      <div className="upcoming-events">
        <h2 className="upcoming-events__title">{translate('Trusted by Leaders in Real-World Asset Tokenization')}</h2>
...
const marketIntegrationData = [
  {
    ...
    description: (
      <>
        Utilize XRP Ledger's native <Link to="/docs/concepts/tokens/decentralized-exchange">decentralized exchange (DEX)</Link> with integrated{' '}
        <Link to="/docs/concepts/tokens/decentralized-exchange/automated-market-makers">Automated Market Makers (AMM)</Link> and onchain 24/7 order
        books, providing a developer-friendly environment to create <Link to="/docs/use-cases/defi">DeFi solutions</Link> for traditional finance
        applications.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        ...
        to lock tokens and facilitate secure, conditional transfers of assets based on time-locks or other conditions to enable automated financial
        use cases onchain.
      </>
    ),
  },
  ...
  },
  {
    ...
    description: 'Access cross-chain trading and lending markets to enhance token utility and liquidity across ecosystems.',
  },
]
...
function TokenUtilitySection() {
  ...
  return (
    <section className="token-utility-section">
      <div className="container">
        <h2 className="section-title">{translate('Token Utility and Market Integration')}</h2>
  ...
  return (
    <section className="token-video-container">
      ...
      <div className="token-video-text-container">
        <p>{translate('Issue, manage, and trade real-world assets without needing to build smart contracts.')}</p>
        <p>
          {translate(
        ...
        <p>{translate('Access the full white paper to learn how XRP Ledger’s new token standard is shaping institutional-grade finance.')}</p>
  ...
  return (
    <section className="token-hero-section">
      ...
      <div className="token-title-container">
        <h1 className="token-title">{translate('Real-World Asset (RWA) Tokenization')}</h1>
        <div className="button-container">
          <Link className="btn btn-primary p-12 btn-arrow-out" target="_blank" to="/static/pdf/Whitepaper_the_future_of_asset_tokenization.pdf">
            {translate('Get Started Now')}
          </Link>
          <Link className="internal-link" to="/docs/use-cases/tokenization/creating-an-asset-backed-multi-purpose-token">
  ...
  return (
    <section className="token-cards-wrapper">
      <div className="token-cards-container">
        <div>
          <h2 className="cards-title-token">{translate('Why Financial Developers Choose XRPL as an RWA Tokenization Platform')}</h2>
        </div>
