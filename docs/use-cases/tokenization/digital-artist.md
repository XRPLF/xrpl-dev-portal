...
For a more hands-on experience, you can follow the steps in the [Quickstart Tutorial 3 - Mint and Burn NFTokens](../../tutorials/tokens/nfts/mint-and-burn-nfts-js.md).
...
See [Mint and Burn NFTokens](../../tutorials/tokens/nfts/mint-and-burn-nfts-js.md).

## Sell NFTs

You transfer NFTs by creating a sell offer. See [Transfer NFTokens](../../tutorials/tokens/nfts/transfer-nfts-js.md).
