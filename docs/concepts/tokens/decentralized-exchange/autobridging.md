...
<img class="autobridging-diagram" src="/img/autobridging.svg" alt="A combined GBP/BRL order book in which auto-bridged offers routed through XRP interleave by price with direct offers. The best-priced offer is auto-bridged but thin; the direct offer below it carries fuller liquidity depth.">
