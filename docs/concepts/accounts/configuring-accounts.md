...
| `disallowIncomingTrustLine` | Block incoming trust lines, including ones that an `OfferCreate` transaction would otherwise create implicitly to receive your tokens. {% amendment-disclaimer name="DisallowIncoming" /%} {% amendment-disclaimer name="fixCleanup3_4_0" /%} |
