...
See also: [Fee Escalation explanation in `rippled` repository](https://github.com/XRPLF/rippled/blob/1e01cd34f7a216092ed779f291b43324c167167a/src/xrpld/app/misc/FeeEscalation.md).
