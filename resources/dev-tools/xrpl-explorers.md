---
seo:
    description: Search and track XRP Ledger accounts, transactions, and network activity with explorers.
labels:
    - Development
---
# XRPL Explorers

The XRP Ledger is transparent by design, and explorers give you access to that data. Explorers are browser-based tools that let _anyone_ view the real-time, on-chain data for the XRP Ledger Mainnet and the test networks, without special permission or an account.
