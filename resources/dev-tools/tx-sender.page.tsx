...
async function onClickCreateEscrow(
  ...
  if (escrowCreateResponse && alsoSendEscrowFinish) {
    ...
    if (escrowCreateResponse.result.tx_json.Sequence === undefined) {
      errorNotif(submitConstData.alert, 'Error: Unable to get the sequence number from EscrowCreate, so cannot submit an EscrowFinish transaction.')
      ...
      <main className="main col-md-7 col-lg-6 order-md-3 page-tx-sender" role="main" id="main_content_body">
        <section className="container-fluid pt-3 p-md-3">
          ...
          <div className="content">
            <p>
              {translate('resources.dev-tool.tx-sender.content.part1', 'This tool sends transactions to the ')}
              <a href="../xrp-faucets">{translate('XRP Testnet')}</a>
              {translate(
                'resources.dev-tool.tx-sender.content.part2',
            ...
            <form>
              ...
              <DestinationAddressInput {...{ defaultDestinationAddress, destinationAddress, setDestinationAddress }} />
              ...
              <TransactionButton
                ...
                content={{
                  ...
                  longerDescription: (
                    <div>
                      {translate('resources.dev-tool.tx-sender.send-xrp-desc.part1', 'Send a ')}
                      <Link to="../../docs/tutorials/how-tos/send-xrp">
                        {translate('resources.dev-tool.tx-sender.send-xrp-desc.part2', 'simple XRP-to-XRP payment')}
                      </Link>
                      {translate('resources.dev-tool.tx-sender.send-xrp-desc.part3', '.')}
                    </div>
                  ),
                }}
                inputSettings={{
              ...
              <TransactionButton
                ...
                transaction={{
                  ...
                  SendMax: {
                    value: (Math.random() * 0.01).toPrecision(15), // random very small amount
                ...
                content={{
                  ...
                  longerDescription: (
                    <div>
                      ...
                      <code>{translate('Amount')}</code>
                      {translate(' value, to test your handling of ')}
                      <Link to="/docs/concepts/payment-types/partial-payments">{translate('partial payments')}</Link>
                      {translate('.')}
                    </div>
                  ),
              ...
              <TransactionButton
                ...
                content={{
                  ...
                  longerDescription: (
                    <div>
                      {translate('Create a ')}
                      <Link to="/docs/concepts/payment-types/escrow">{translate('time-based escrow')}</Link>
              ...
              <TransactionButton
                ...
                content={{
                  ...
                  longerDescription: (
                    <div>
                      {translate('Create a ')}
                      <Link to="../../docs/concepts/payment-types/payment-channels">{translate('payment channel')}</Link>
