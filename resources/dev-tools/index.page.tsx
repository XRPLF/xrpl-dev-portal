...
const explorers_tools = [
  {
    id: 'xrp-explorer',
    title: 'XRPL Explorer',
    description: 'View validations of new ledger versions in real-time, or chart the location of servers in the XRP Ledger.',
  ...
  },
  {
    ...
    description: "Explore public ledger data including accounts' transaction history and known names.",
  ...
  },
  {
    id: 'xrpscan',
    title: 'XRPScan',
    description: 'Explore ledger activity, view amendment voting in real-time, and get account information. API access is also available.',
  ...
  },
  {
    id: 'token-list',
    title: 'Token List',
    description: 'See all tokens issued in the XRP Ledger and use preset tools to issue custom tokens at the click of a button.',
...
const api_access_tools = [
  ...
  },
  {
    id: 'rpc',
    title: 'RPC Tool',
    description: 'Print raw information about an XRP Ledger account, transaction, or ledger.',
...
const other = [
  ...
  },
  {
    ...
    description: "Parse the XRP Ledger's native binary format with a visual representation breaking down the raw structure into its parts.",
  ...
  },
  {
    ...
    description: 'Query known information about any token issued on the XRP Ledger.',
      ...
      <div>
        <section className="py-20">
          <div className="mx-auto text-lg-left">
            <div className="d-flex flex-column-reverse">
              <p className="mb-0">{translate('Use the developer tools to test, explore, and validate XRP Ledger API requests and behavior.')}</p>
        ...
        <section className="py-10">
          <div className="mx-auto text-lg-left">
            ...
            <div className="tab-content pt-20">
              <div className="tab-pane show active" id="explorers" role="tabpanel" aria-labelledby="explorers-tab">
                <h4> {translate('Explorers')}</h4>
                <div className="row row-cols-1 row-cols-lg-3 card-deck">
                  {explorers_tools.map((card) => (
                    <Link className="card" to={card.href} target="_blank" rel="noopener noreferrer" id={card.id} key={card.id}>
                      {card.img && <img src={card.img} alt={`${card.title} Screenshot`} />}
              ...
              <div className="tab-pane" id="api-access" role="tabpanel" aria-labelledby="api-access-tab">
                <h4> {translate('API Access')}</h4>
                <div className="row row-cols-1 row-cols-lg-3 card-deck">
                  {api_access_tools.map((card) => (
                    <Link className="card" to={card.href} target="_blank" id={card.id} key={card.id}>
                      {card.img && <img src={card.img} alt={card.title + ' Screenshot'} />}
                      <div className="card-body">
                        <h4 className="card-title h5">{translate(card.title)}</h4>
                        <p className="card-text">{translate(card.description)}</p>
        ...
        <section className="container-new py-10 px-0">
          <div className="col-lg-12 p-6-sm p-10-until-sm br-8 cta-card">
            <img alt="purple waves" src={require('../../static/img/backgrounds/cta-home-purple.svg')} className="d-none-sm cta cta-top-left" />
            <img alt="green waves" src={require('../../static/img/backgrounds/cta-home-green.svg')} className="cta cta-bottom-right" />
            <div className="z-index-1 position-relative">
              <h2 className="h4 mb-8-sm mb-10-until-sm">{translate('Have an Idea For a Tool?')}</h2>
              <p className="mb-10">
                {translate(
              ...
              <a className="btn btn-primary btn-arrow-out" href="https://github.com/XRPLF/xrpl-dev-portal/">
