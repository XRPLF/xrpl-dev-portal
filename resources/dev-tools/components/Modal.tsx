      ...
      <div className="modal-dialog modal-dialog-centered" role="document">
        <div className="modal-content">
          <div className="modal-header">
            ...
            <button type="button" className="close" aria-label="Close" onClick={onClose} data-dismiss="modal">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div className="modal-body">{children}</div>
          <div className="modal-footer">{footer ? footer : <ModalCloseBtn onClick={onClose} />}</div>
        </div>
      </div>
    </div>
  )
...
export const ModalCloseBtn = ({ onClick }) => {
  ...
  return (
    <button type="button" className="btn btn-outline-secondary" data-dismiss="modal" onClick={onClick}>
      {translate('Close')}
    </button>
  )
}
...
export const ModalClipboardBtn = ({ textareaRef }) => {
  ...
  return (
    <button title={translate('Copy to clipboard')} className="btn btn-outline-secondary clipboard-btn" onClick={() => copyToClipboard(textareaRef)}>
